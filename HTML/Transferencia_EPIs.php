    ...
    <script type="text/javascript">  
        ...
        function procura_registro_epi(campo) {
            ...
            if (acao=='A'){
                        ...
                        document.forms[3].elements["txt_log_ultima_atualizacao"].value = new String(newepis.get_Ultima_Atualizacao());                        
                        document.forms[3].elements["txt_log_ultimo_usuario"].value = new String(newepi.get_Ultimo_Usuario());                
...
<center>
  <h1>Transferência  de EPIs entre Unidades </h1>
...
<script type="text/javascript" src="../classes/js/Abas.js"></script>
      ...
      <table width="35%" border="0" cellpadding="0" cellspacing="1">
            <tr>
                <td width="28%" height="36" align="center" valign="middle" class="abaativa" id="celAbaEnvio" onClick="trataCliqueAba( this.id );" onMouseOver="trataMouseAba( this );">
                Envio</td>                
                <td width="32%" height="36" align="center" valign="middle" class="abaativa" id="celAbaRecebimento" onClick="trataCliqueAba( this.id );" onMouseOver="trataMouseAba( this );">
                Recebimento</td>                
                <td width="40%" height="36" align="center" valign="middle" class="abaativa" id="celAbaTransferencias" onClick="trataCliqueAba( this.id );" onMouseOver="trataMouseAba( this );">
                Transferências não conclu&iacute;das </td>                

                
            </tr>
      </table>	  
      <div id="divEnvio" style="display: block;overflow:auto;height:60%;min-height:60%;" >
       <form id="frm_epis" method="POST">
      
          <table width="95%" border="0" class="tabela" >
          <tr>
            <td>Unidade Origem </td>
            <td><input type="text" name="UNIDADE_ORIGEM" maxlength="10" readonly="readonly" size="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)" value="<?php echo $_SESSION['unidade']?>" /></td>
            <td colspan="2"><input type="text"  maxlength="50" readonly="readonly" size="50" value="<?php echo $_SESSION['nome_unidade']?>" /></td>  
             <td>&nbsp;</td>
             <td>Quantidade Total Enviada </td>
             <td><input type="text" name="QTDE_TOTAL_ENVIADA" disabled="disabled" maxlength="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)"  size="10"/></td>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
             <td width="90">&nbsp;</td>
             <td width="78">&nbsp;</td>
          ...
          <tr>
            <td height="24">Unidade Destino </td>
            <td><input type="text" name="CODIGO_UNIDADE_DESTINO" maxlength="10" size="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)" /></td>
            <td colspan="7"><select id="UNIDADE_DESTINO" style="width:250px">
            </select></td>
            <td colspan="3">&nbsp;</td>
            </tr>
          <tr>
            <td width="78">N&uacute;mero do Movimento </td>
            <td width="117"><p>
            ...
            <td width="50">Data de Envio </td>
            <td width="252"><input type="text" name="DATA_ENVIO" maxlength="20" class="input" size="20" onkeyup="return formata_data_hora(this,'eu',event);" onkeypress="return valida_data_hora(this,event)" onfocus="data_hoje(this)"/></td>
            <td width="83">Data de Recebimento</td>
            <td width="162"><input type="text" name="DATA_RECEBIMENTO" maxlength="20" class="input" size="20" readonly="readonly" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)" onfocus="data_hoje(this)"/></td>
            <td width="89">Tipo de Movimento </td>
            <td width="107"><select name="select" style="width:100px">
              <option value=" "></option>
              <option value="E" selected>(Envio)</option>
            </select></td>
            <td width="67">Situa&ccedil;&atilde;o</td>
            <td colspan="3"><select name="select3" disabled="disabled">
              <option value="(Pendente)" selected="selected"></option>
		...
		<table width="95%" border="1px solid" class="tabela_epis" >
		  <!--DWLayoutTable-->
		<tr>
		<td width="10%" height="30">Código EPI</td>
		<td width="30%">Descrição</td>
		<td width="13%">Tipo de Proteção</td>
		<td width="10%"><div align="center">Qtde a enviar </div></td>				
      ...
      <form id="frm_entrada_epis">
		  ...
		  <td width="10%"><input type="text" name="VIDA_UTIL" maxlength="12" disabled="disabled" class="input" size="12"/></td>
		  <td width="10%"><input type="text" name="VIDA_UTIL2" disabled="disabled"  maxlength="13" class="input" size="13"/></td>
      ...
      <div id="divRecebimento" style="display: block;overflow:auto;height:60%;min-height:60%;" >
       <form id="frm_epis" method="POST">
         <table width="95%" border="0" class="tabela" >
           <tr>
             <td>Unidade Destino </td>
             <td><input type="text" name="UNIDADE_DESTINO" maxlength="10" readonly="readonly" size="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)" value="<?php echo $_SESSION['unidade']?>" /></td>
             <td colspan="2"><input name="text" type="text" value="<?php echo $_SESSION['nome_unidade']?>" size="50"  maxlength="50" readonly="readonly" /></td>
             <td>&nbsp;</td>
             <td>Quantidade Total Recebida </td>
             <td><input type="text" name="QTDE_TOTAL_RECEBIDA" maxlength="10"  disabled="disabled" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)"  size="10"/></td>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
             <td width="86">&nbsp;</td>
             <td width="82">&nbsp;</td>
           ...
           <tr>
             <td>Unidade Origem </td>
             <td><input type="text" name="CODIGO_UNIDADE_ORIGEM" maxlength="10" size="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)" /></td>
             <td colspan="2"><select name="select2" id="UNIDADE_ORIGEM" style="width:250px">
             </select></td>
             <td>&nbsp;</td>
             <td>Quantidade Total Enviada</td>
             <td><input type="text" name="QTDE_TOTAL_ENVIADA2" maxlength="10" disabled="disabled" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)"  size="10"/></td>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
           ...
           <tr>
             <td width="99">N&uacute;mero do Movimento </td>
             <td width="97"><p>
                 <input type="text" name="SEQUENCIAL2" maxlength="10" size="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)" />
                 <img src="../images/search.png" width="10px" height="10px"/></p></td>
             <td width="45"><div align="left">Data de Envio </div></td>
             <td width="234"><input type="text" name="DATA_ENVIO2" maxlength="20" class="input" size="20" readonly="readonly" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)" onfocus="data_hoje(this)"/></td>
             <td width="83">Data de Recebimento</td>
             <td width="164"><input type="text" name="DATA_RECEBIMENTO2" maxlength="20" class="input" size="20"  onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)" onfocus="data_hoje(this)"/></td>
             <td width="90">Tipo de Movimento</td>
             <td width="112"><select name="TIPO_MOVIMENTACAO">
               <option value=" "></option>
               <option value="D">Devolução</option>
               <option value="R">Recebimento</option>
             </select></td>
             <td width="81">Situa&ccedil;&atilde;o</td>
             <td colspan="3"><select name="SITUACAO" disabled="disabled">
               <option value="(Pendente)" selected="selected"></option>
               <option value="C">Cancelada</option>
               <option value="D">Devolvida</option>
               <option value="R">Recebida</option>
		...
		<table width="95%" border="1px solid" class="tabela_epis" >
		  <!--DWLayoutTable-->
		<tr>
		<td width="11%" height="30">Código EPI</td>
		<td width="31%">Descrição</td>
		<td width="14%">Tipo de Proteção</td>
		<td width="9%"><div align="center">Qtde enviada </div></td>				
		<td width="8%"><div align="center">Qtde recebida </div></td>				
		<td width="10%">Valor Unit&aacute;rio</td>
		<td width="10%">Valor Total </td>						

		<td width="7%"><div align="center">Confirmar Linha </div></td>
		</tr>
		</table>
      ...
      <form id="frm_entrada_epis">
          <table width="95%" border="1px solid" class="tabela_epis" >
                <tr>
		  <td width="11%" height="26"><input type="text" name="CODIGO_EPIS" maxlength="10" style="text-align:right" class="input" size="7" onkeypress="return entrada_numerica_inteira(this,event)"  onblur="procura_registro_epi(this);" />
	      <img src="../images/search.png" width="10px" height="10px"/></td>
		  <td width="31%"><input  type="text" disabled="disabled" name="DESCRICAO_EPI" maxlength="55" class="input" size="55"/></td>
		  <td width="14%"><input type="text" name="TIPO_PROTECAO" disabled="disabled"  maxlength="10" class="input" size="20"/></td>
		  <td width="9%"><div align="center">
		    <input type="text" name="QTDE_ENVIADA" maxlength="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)"  size="10"/>
		    </div></td>
		  <td width="8%"><div align="center">
            <input type="text" name="QTDE_RECEBIDA" maxlength="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)"  size="10"/>
          </div></td>
		  <td width="10%"><input type="text" name="VIDA_UTIL3" maxlength="10" disabled="disabled" class="input" size="10"/></td>
		  <td width="10%"><input type="text" name="VIDA_UTIL2" disabled="disabled"  maxlength="10" class="input" size="13"/></td>
       		<td width="7%" valign="top"><button type="button" value="Inserir" onclick="inserir_linha_detalhe();">Inserir</button></td>
		</tr>
          </table>
		</BR>
		<div style="height:300px;overflow:scroll;width:95%">
      ...
      <input type="text" id="txt_pesquisa" name="txt_pesquisa" size="50"/>
        ...
        <div id="divModelo" style="display: none">
            <table border="0" width="50%">
              ...
              <script>
            defineAba( "celAbaEnvio"  , "divEnvio"   );
            defineAba( "celAbaRecebimento" , "divRecebimento" );
            defineAbaAtiva( "celAbaEnvio" );
        </script>
