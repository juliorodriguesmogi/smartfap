...
<div id="DIV_PRINCIPAL" style="bottom:0px">
    ...
    <form id="frm_empresas" action="empresas.php" method="POST">
      <div id="divCadastro" style="display: block;overflow:auto;height:60%;min-height:60%;min-width:70%" >
        ...
        <div >
          <table class="tabela" width="81%" border="0" bgcolor="whitesmoke">
            ...
            <tr>
              <th colspan="20"><div align="center">Endere&ccedil;o de Atua&ccedil;&atilde;o </div><div><input name="MESMO_ENDERECO_COBRANCA" type="checkbox" onclick="clona_enderecos(this)" />Utilizar o endereço comercial como o endereço de atuação</div></th>
            </tr>
            <tr>
              <td width="74">Tipo Logradouro</td>
      ...
      <div id="divDocumentacao" style="display: none" >
            <table border="0" width="81%" bgcolor="whitesmoke">
				<tr>
                <td width="60">Nome do Responsável</td>
				<td colspan="2"><input type="text" name="NOME_RESPONSAVEL" size="50"/></td>
                <td width="60">NIT do Responsável</td>
    ...
    <td  width="5%">Ano Perícia</td>
    <td  width="5%">Revisão </td>
    <td  width="9%">Data de Lançamento</td>
    <td  width="8%">Data de Criação </td>
    <td  width="11%">Última Atualização </td>
  </tr>
