...
<script type="text/javascript" src="../classes/js/Fabricantes.js"></script>
    <script type="text/javascript">  
         ...
         newepis=new epis();
         newrecebimentoepi_d=new Movimento_Epi_d();
         newrecebimentoepi_d.inicializa();
        ...
        function procura_registro_movimentacao(campo) {
            ...
            exibe_campos_mestre();
            newrecebimentoepi_d.inicializa();
            buscar_registros(window,'movimentacao_epis_d', 'Busca_Movimentacao_Epis_d','SEQUENCIAL',newmovimentoepi_m.get_Sequencial(),false,Array("="),newrecebimentoepi_d);            
        ...
        function exibe_campos_detalhes(){
            ...
            if (acao=='A'){
                ...
                response=Array();
                for(x=0;x<newrecebimentoepi_d.length();x++){
                    response[0]=newrecebimentoepi_d.get_Codigo_Epi(x);
                    response[1]=newrecebimentoepi_d.get_Descricao_Epi(x);
                    response[2]=newrecebimentoepi_d.get_Tipo_Protecao(x);                    
                    response[3]=newrecebimentoepi_d.get_Quantidade_Fornecida(x);                    
                    response[4]=newrecebimentoepi_d.get_Valor_Unitario(x);                    
                    response[5]=newrecebimentoepi_d.get_Valor_Total(x);                    
                    response[6]=newrecebimentoepi_d.get_Proxima_Troca(x);
        ...
        function procura_registro_epi(campo) {
            ...
            if (acao=='A'){
                        ...
                        document.forms[2].elements["VALOR_UNITARIO"].value = new String(newepis.get_Valor_Unitario());    
                        document.forms[2].elements["VALOR_TOTAL"].value = new String(newepis.get_Valor_Total());    
        ...
        function exibe_campos(){
            ...
            function grava_registro(){
             if (confirm("Confirma o registro")){
                document.forms[1].action="../PHP/Movimento_Epis_Class.php?acao="+"I"+"&newrecebimentoepi_d="+newrecebimentoepi_d.retorna_todas_linhas();
            ...
            function apaga_linha(td){
                ...
                newrecebimentoepi_d.apaga_linha(ttr.rowIndex);
		...
		if (document.forms[2].elements['QTDE_FORNECIDA'].value==0) {
                ...
                response[4]=document.forms[2].elements['VALOR_UNITARIO'].value;
                response[5]=document.forms[2].elements['VALOR_TOTAL'].value;
                ...
                response[4]='VIDA_UNITARIO'+'='+response[4];
                response[5]='VIDA_TOTAL'+'='+response[5];
                ...
                Xresp2=Xresp.join('|');
                newrecebimentoepi_d.setValores(Xresp2);
...
<center>
  <h1>Recebimento/Devolu&ccedil;&atilde;o de EPIs de Fornecedores </h1>
</center>
...
<script type="text/javascript" src="../classes/js/Abas.js"></script>
      ...
      <link href="estilosistema.css" type="text/css" rel="stylesheet" />
        <table width="17%" border="0" cellpadding="0" cellspacing="1">
            <tr>
                <td width="49%" height="36" align="center" valign="middle" class="abaativa" id="celAbaRecebimento" onClick="trataCliqueAba( this.id );" onMouseOver="trataMouseAba( this );">
                Recebimento</td>                
                <td width="51%" height="36" align="center" valign="middle" class="abaativa" id="celAbaDevolucao" onClick="trataCliqueAba( this.id );" onMouseOver="trataMouseAba( this );">
                Devolução</td>                
      ...
      <div id="divRecebimento" style="display: block;overflow:auto;height:60%;min-height:60%;" >
       <form id="frm__recebimento_epis" name="frm__recebimento_epis" method="POST">
...
<td>Unidade</td>
          ...
          <tr>
            ...
            <td colspan="3">Nome do Fornecedor</td>
            ...
            <td width="94" colspan="2"><input type="text" name="DATA_MOVIMENTACAO" maxlength="10" class="input" size="10" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)" onfocus="data_hoje(this)"/></td>
			</tr>
			<tr>
            ...
            <td width="8">&nbsp;</td>
            <td width="150">Data de Emiss&atilde;o da Nota Fiscal/Nfe </td>
			  <td width="119"><input type="text" name="DATA_EMISSAO" maxlength="10" size="10" style="text-align:right" class="input" onkeypress="return entrada_numerica_inteira(this,event)" /></td>
			  <td width="119">Data de Recebimento </td>
			  <td width="127"><input type="text" name="DATA_EMISSAO2" maxlength="10" size="10" style="text-align:right" class="input" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)" /></td>
			  <td width="58"></td>			  
		...
		<td width="10%"><div align="center">Qtde Recebida</div></td>				
      ...
      <form id="frm_entrada_epis">
		  ...
		  <td width="10%"><input type="text" name="VALOR_UNITARIO" maxlength="10" disabled="disabled" class="input" size="10"/></td>
		  <td width="10%"><input type="text" name="VALOR_TOTAL" disabled="disabled"  maxlength="10" class="input" size="13"/></td>
		...
		<div style="width:95%">
			<p align="right">Qtde Total Recebida <input name="QTDE_TOTAL_RECEBIDA" SIZE="10" disabled/></p>
			<p align="right">Valor Total Recebido <input name="VALOR_TOTAL_RECEBIDO" size="15" disabled /></p>
		</div>
      ...
      <div id="divDevolucao" style="display: block;overflow:auto;height:60%;min-height:60%;" >
       <form id="frm_devolucao_epis" name="frm_devolucao_epis" method="POST">
...
<td>Unidade</td>
      ...
      <form id="frm_entrada_epis">
		...
		<tbody id="t_body" style="overflow:auto">
						...
						<div style="width:95%">
			<p align="right">Qtde Total Devolvida 
			  <input name="QTDE_TOTAL_RECEBIDA" SIZE="10" disabled/></p>
			<p align="right">Valor Total  Devolvido 
			  <input name="VALOR_TOTAL_RECEBIDO" size="15" disabled /></p>
		</div>
      ...
      <div id="div_statusbar">
        ...
        <div id="divModelo" style="display: none">
            ...
            defineAbaAtiva( "celAbaRecebimento" );
        </script>
