...
<center><h1>Cadastro de Setores Objetos da Perícia</h1></center>
      ...
      <form id="frm_setores" method="POST">
        <table width="35%" border="0" cellpadding="0" cellspacing="1" >
          <tr>
            ...
            <td width="10%" height="36" align="center" valign="middle" class="abainativa" id="celAbaHistExp" onclick="trataCliqueAba( this.id );" onmouseover="trataMouseAba( this );"> Histórico de Exposições</td>
            <td width="10%" height="36" align="center" valign="middle" class="abainativa" id="celAbaHistAtiv" onclick="trataCliqueAba( this.id );" onmouseover="trataMouseAba( this );"> Histórico de Atividades</td>
          </tr>
        </table>
        <div id="divCadastro" style="display: block;overflow:auto;height:60%;min-height:60%;width:95%" >
          ...
          <div id="divHistoricoExposicao" style="display:none">
            ...
            <thead>
                ...
                <th>Riscos</th>
                <th>Periodicidade</th>
                <th>Nro Funcionários</th>
                <th>Nro Funcionários Expostos</th>
...
<caption><center>Características do Setor</center></caption>
<tbody>
<tr>
<td width="34%">Ítens das características do Setor
<td>&nbsp;</td>
<td width="33%">
