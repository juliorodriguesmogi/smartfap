...
<script type="text/javascript" src="../classes/js/MTextos_padrao.js"></script>
<script type="text/javascript" src="../classes/js/MEnquadramentos.js"></script>
		...
		divpai.removeChild(divremover);
            ...
            function executar_tipo(){
				...
				if (qualitativa.checked) {
					...
					dv.getElementsByTagName('input')[2].value=divpai.getElementsByTagName('select')[1].value;
                                        ...
                                        buscar_registros(window,'textos_padrao','Busca_Textos_Padrao',Array('NOME_AGENTE','CLASSIFICACAO_TEXTO'),Array(nome_campo.toUpperCase(),'QUALITATIVA'),false,Array('=','='),newtextospadrao);
                                        if (newtextospadrao.length()>0) tabela.rows[3].cells[0].children[0].children[0].value=newtextospadrao.get_Texto(0);
				...
				if (quantitativa.checked) {
					...
					dv.getElementsByTagName('input')[2].value=divpai.getElementsByTagName('select')[1].value;				
                                        ...
                                        buscar_registros(window,'textos_padrao','Busca_Textos_Padrao',Array('NOME_AGENTE','CLASSIFICACAO_TEXTO'),Array(nome_campo.toUpperCase(),'QUANTITATIVA'),false,Array('=','='),newtextospadrao);
					if (newtextospadrao.length()>0)  tabela2.rows[3].cells[0].children[0].children[0].value=newtextospadrao.get_Texto(0);
                                        divpai.appendChild(dv);
				}	
           ...
           function carregar_maquinas_equipamentos_avaliacao(dv){
                ...
                for (xo=0;xo<newMaquinas.length();xo++){
                    ...
                    if (dv.children[0].id=='tabela_modelo_avaliacao_iluminamento_quantitativa'){
                        linhax.cells[3].children[0].value=newMaquinas.get_Taxa_De_Luminosidade(xo);
                    }
                    else if (dv.children[0].id=='tabela_modelo_avaliacao_ruido_quantitativa') {
                       ...
                       case "calor":    
                        ...
                        case "sangue_animal":
                         ...
                         case "outros_quimicos":
                            ...
                            break;
                         case "defensivos_agricolas":
                           exibir_historico_avaliacoes_defensivos_agriculas(dv);
                           break;
		 ...
		 buscar_registros(window,'laudos_avaliacoes_ruido',"Carrega_Avaliacoes_Ruido",campos_aval_ruido,valores_aval_ruido,false,Array('=','=','=','=','=','='),newlaudoavalruido);
                 ...
                 for (xs=0;xs<newlaudoavalruido.length();xs++){
                  ...
                  tabelaruido.rows[18].cells[1].children[0].value=newlaudoavalruido.get_Grau_Risco(xs);
		 ...
		 buscar_registros(window,'laudos_avaliacoes_iluminamento',"Carrega_Avaliacoes_iluminamento",campos_aval_iluminamento,valores_aval_iluminamento,false,Array('=','=','=','=','=','='),newlaudoavaliluminamento);
                 ...
                 for (xs=0;xs<newlaudoavaliluminamento.length();xs++){
                  ...
                  tabelaruido.rows[3].cells[0].children[0].children[0].value=newlaudoavaliluminamento.get_Texto_explicativo(xs);
                  ...
                  tabelailuminamento.rows[12].cells[1].children[0].value=newlaudoavaliluminamento.get_Grau_risco(xs);
...
function exibir_historico_avaliacoes_calor(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_calor',"Carrega_Avaliacoes_Calor",campos_aval_calor,valores_aval_calor,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_calor);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_calor.length();xs++){
                  ...
                  tabelacalor.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_calor.get_Texto_explicativo(xs);
                  ...
                  tabelacalor.rows[16].cells[1].children[0].value=newlaudosavaliacoes_calor.get_Grau_risco(xs);
...
function exibir_historico_avaliacoes_frio(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_frio',"Carrega_Avaliacoes_Frio",campos_aval_frio,valores_aval_frio,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_frio);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_frio.length();xs++){
                  ...
                  tabelafrio.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_frio.get_Texto_explicativo(xs);
                  ...
                  tabelafrio.rows[15].cells[1].children[0].value=newlaudosavaliacoes_frio.get_Grau_risco(xs);
...
function exibir_historico_avaliacoes_umidade(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_umidade',"Carrega_Avaliacoes_umidade",campos_aval_umidade,valores_aval_umidade,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_umidade);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_umidade.length();xs++){
                  ...
                  tabelaumidade.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_umidade.get_Texto_explicativo(xs);
                  ...
                  tabelaumidade.rows[16].cells[1].children[0].value=newlaudosavaliacoes_umidade.get_Grau_risco(xs);
...
function exibir_historico_avaliacoes_radiacao_nao_ionizante(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_radiacao_nao_ionizante',"Carrega_Avaliacoes_radiacao_nao_ionizante",campos_aval_radiacao_nao_ionizante,valores_aval_radiacao_nao_ionizante,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_radiacao_nao_ionizante);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_radiacao_nao_ionizante.length();xs++){
                  ...
                  tabelaradiacao_nao_ionizante.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_radiacao_nao_ionizante.get_Texto_explicativo(xs);
                  ...
                  tabelaradiacao_nao_ionizante.rows[14].cells[1].children[0].value=newlaudosavaliacoes_radiacao_nao_ionizante.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_radiacao_ionizante(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_radiacao_ionizante',"Carrega_Avaliacoes_radiacao_ionizante",campos_aval_radiacao_ionizante,valores_aval_radiacao_ionizante,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_radiacao_ionizante);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_radiacao_ionizante.length();xs++){
                  ...
                  tabelaradiacao_ionizante.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_radiacao_ionizante.get_Texto_explicativo(xs);
                  ...
                  tabelaradiacao_ionizante.rows[14].cells[1].children[0].value=newlaudosavaliacoes_radiacao_ionizante.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_outros_fisicos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_outros_fisicos',"Carrega_Avaliacoes_outros_fisicos",campos_aval_outros_fisicos,valores_aval_outros_fisicos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_outros_fisicos);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_outros_fisicos.length();xs++){
                  ...
                  tabelaoutros_fisicos.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_outros_fisicos.get_Texto_explicativo(xs);
                  ...
                  tabelaoutros_fisicos.rows[14].cells[1].children[0].value=newlaudosavaliacoes_outros_fisicos.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_sangue_humano(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_sangue_humano',"Carrega_Avaliacoes_sangue_humano",campos_aval_sangue_humano,valores_aval_sangue_humano,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_sangue_humano);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_sangue_humano.length();xs++){
                  ...
                  tabelasangue_humano.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_sangue_humano.get_Texto_explicativo(xs);
                  ...
                  tabelasangue_humano.rows[15].cells[1].children[0].value=newlaudosavaliacoes_sangue_humano.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_sangue_animal(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_sangue_animal',"Carrega_Avaliacoes_sangue_animal",campos_aval_sangue_animal,valores_aval_sangue_animal,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_sangue_animal);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_sangue_animal.length();xs++){
                  ...
                  tabelasangue_animal.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_sangue_animal.get_Texto_explicativo(xs);
                  ...
                  tabelasangue_animal.rows[14].cells[1].children[0].value=newlaudosavaliacoes_sangue_animal.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_manejo_animais(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_manejo_animais',"Carrega_Avaliacoes_manejo_animais",campos_aval_manejo_animais,valores_aval_manejo_animais,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_manejo_animais);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_manejo_animais.length();xs++){
                  ...
                  tabelamanejo_animais.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_manejo_animais.get_Texto_explicativo(xs);
                  ...
                  tabelamanejo_animais.rows[14].cells[1].children[0].value=newlaudosavaliacoes_manejo_animais.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_outros_biologicos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_outros_biologicos',"Carrega_Avaliacoes_outros_biologicos",campos_aval_outros_biologicos,valores_aval_outros_biologicos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_outros_biologicos);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_outros_biologicos.length();xs++){
                  ...
                  tabelaoutros_biologicos.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_outros_biologicos.get_Texto_explicativo(xs);
                  ...
                  tabelaoutros_biologicos.rows[14].cells[1].children[0].value=newlaudosavaliacoes_outros_biologicos.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_fumos_metalicos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_fumos_metalicos',"Carrega_Avaliacoes_fumos_metalicos",campos_aval_fumos_metalicos,valores_aval_fumos_metalicos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_fumos_metalicos);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_fumos_metalicos.length();xs++){
                  ...
                  tabelafumos_metalicos.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_fumos_metalicos.get_Texto_explicativo(xs);
                  ...
                  tabelafumos_metalicos.rows[14].cells[1].children[0].value=newlaudosavaliacoes_fumos_metalicos.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_hidrocarbonetos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_hidrocarbonetos',"Carrega_Avaliacoes_hidrocarbonetos",campos_aval_hidrocarbonetos,valores_aval_hidrocarbonetos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_hidrocarbonetos);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_hidrocarbonetos.length();xs++){
                  ...
                  tabelahidrocarbonetos.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_hidrocarbonetos.get_Texto_explicativo(xs);
                  ...
                  tabelahidrocarbonetos.rows[14].cells[1].children[0].value=newlaudosavaliacoes_hidrocarbonetos.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_produtos_limpeza(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_produtos_limpeza',"Carrega_Avaliacoes_produtos_limpeza",campos_aval_produtos_limpeza,valores_aval_produtos_limpeza,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_produtos_limpeza);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_produtos_limpeza.length();xs++){
                  ...
                  tabelaprodutos_limpeza.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_produtos_limpeza.get_Texto_explicativo(xs);
                  ...
                  tabelaprodutos_limpeza.rows[14].cells[1].children[0].value=newlaudosavaliacoes_produtos_limpeza.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_tintas_solventes(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_tintas_solventes',"Carrega_Avaliacoes_tintas_solventes",campos_aval_tintas_solventes,valores_aval_tintas_solventes,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_tintas_solventes);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_tintas_solventes.length();xs++){
                  ...
                  tabelatintas_solventes.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_tintas_solventes.get_Texto_explicativo(xs);
                  ...
                  tabelatintas_solventes.rows[14].cells[1].children[0].value=newlaudosavaliacoes_tintas_solventes.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_poeiras_incomodas(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_poeiras_incomodas',"Carrega_Avaliacoes_poeiras_incomodas",campos_aval_poeiras_incomodas,valores_aval_poeiras_incomodas,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_poeiras_incomodas);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_poeiras_incomodas.length();xs++){
                  ...
                  tabelapoeiras_incomodas.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_poeiras_incomodas.get_Texto_explicativo(xs);
                  ...
                  tabelapoeiras_incomodas.rows[14].cells[1].children[0].value=newlaudosavaliacoes_poeiras_incomodas.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_defensivos_agriculas(dv){
                 campos_aval_defensivos_agriculas=Array();
                 campos_aval_defensivos_agriculas[0]="CODIGO_EMPRESA";
                 campos_aval_defensivos_agriculas[1]="ANO_PERICIA";
                 campos_aval_defensivos_agriculas[2]="NUMERO_LAUDO";
                 campos_aval_defensivos_agriculas[3]="REVISAO";
                 campos_aval_defensivos_agriculas[4]="UNIDADE";
                 campos_aval_defensivos_agriculas[5]="CODIGO_SETOR"
                 valores_aval_defensivos_agriculas=Array();
                 valores_aval_defensivos_agriculas[0]=document.forms[1].elements['laudos|CODIGO_EMPRESA'].value;
                 valores_aval_defensivos_agriculas[1]=document.forms[1].elements['laudos|ANO_PERICIA'].value;
                 valores_aval_defensivos_agriculas[2]=document.forms[1].elements['laudos|NUMERO_LAUDO'].value;
                 valores_aval_defensivos_agriculas[3]=document.forms[1].elements['laudos|REVISAO'].value;
                 valores_aval_defensivos_agriculas[4]=newlaudosavaliacoes.get_Unidade(numocur);
                 valores_aval_defensivos_agriculas[5]=newlaudosavaliacoes.get_Codigo_Setor(numocur);
                 
		 buscar_registros(window,'laudos_avaliacoes_defensivos_agriculas',"Carrega_Avaliacoes_defensivos_agriculas",campos_aval_defensivos_agriculas,valores_aval_defensivos_agriculas,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_defensivos_agriculas);
                 indice=localizar_indice_componente(dv,'tabela_modelo_avaliacao_defensivos_agriculas_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase(),'table');
                 tabeladefensivos_agriculas=dv.getElementsByTagName('table')[indice];
                 
                 
                 
                 for (xs=0;xs<newlaudosavaliacoes_defensivos_agriculas.length();xs++){
                  tabeladefensivos_agriculas.rows[1].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Tipo_avaliacao(xs);
                  tabeladefensivos_agriculas.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Texto_explicativo(xs);
                  tabeladefensivos_agriculas.rows[4].cells[0].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Unidade(xs);
                  tabeladefensivos_agriculas.rows[4].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Codigo_setor(xs);
                  tabeladefensivos_agriculas.rows[5].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Periodicidade_exposicao(xs);
                  tabeladefensivos_agriculas.rows[6].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Numero_funcs_setor(xs);
                  tabeladefensivos_agriculas.rows[7].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Numero_funcs_expostos(xs);
                  tabeladefensivos_agriculas.rows[10].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Medidas_protecao_coletiva(xs);
                  tabeladefensivos_agriculas.rows[10].cells[1].children[1].value=newlaudosavaliacoes_defensivos_agriculas.get_Medidas_protecao_coletiva_outros(xs);
                  tabeladefensivos_agriculas.rows[11].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Medidas_protecao_individual(xs);
                  tabeladefensivos_agriculas.rows[11].cells[2].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Medidas_protecao_individual_outros(xs);
                  tabeladefensivos_agriculas.rows[12].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Fonte_geradora(xs);
                  tabeladefensivos_agriculas.rows[13].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Enquadramento(xs);
                  tabeladefensivos_agriculas.rows[14].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas.get_Grau_risco(xs);
                 }
               
                 divmaqdefensivos_agriculas=tabeladefensivos_agriculas.rows[9].cells[0].children[0];
                 divmaq=divmaqdefensivos_agriculas.children[0].cloneNode(true);
                 
                 buscar_registros(window,'laudos_avaliacoes_defensivos_agriculas_maquinas',"Carrega_Avaliacoes_defensivos_agriculas_Maquinas",campos_aval_defensivos_agriculas,valores_aval_defensivos_agriculas,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_defensivos_agriculas_maquinas);
                 if (newlaudosavaliacoes_defensivos_agriculas_maquinas.length()>0) while (divmaqdefensivos_agriculas.children.length>0) divmaqdefensivos_agriculas.removeChild(divmaqdefensivos_agriculas.children[0]);
                 for (xs=0;xs<newlaudosavaliacoes_defensivos_agriculas_maquinas.length();xs++){
                     buscar_registro(window,Array('UNIDADE','CODIGO_SETOR','CODIGO_MAQUINA'),Array(newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Unidade(xs),newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Codigo_setor(xs),newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Codigo_maquina(xs)),Array('=','=','=','=','='),'maquinas','maquinas','Busca_Maquina',false,newmaquina);
                     
                     divmaq2=divmaq.cloneNode(true);
                     
                     tabelamaqdefensivos_agriculas=divmaq2.getElementsByTagName('table')[0];
                     tabelamaqdefensivos_agriculas.rows[0].cells[0].children[0].value=newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Unidade(xs);
                     tabelamaqdefensivos_agriculas.rows[0].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Codigo_setor(xs);
                     tabelamaqdefensivos_agriculas.rows[0].cells[2].children[0].length=0;
                     tabelamaqdefensivos_agriculas.rows[0].cells[2].children[0].add(new Option(newmaquina.get_Nome(),newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Codigo_maquina(xs)));
                     tabelamaqdefensivos_agriculas.rows[0].cells[3].children[0].value=newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Nivel_medido(xs);
                     tabelamaqdefensivos_agriculas.rows[0].cells[4].children[0].value=newlaudosavaliacoes_defensivos_agriculas_maquinas.get_Nivel_permitido(xs);
                     divmaqdefensivos_agriculas.appendChild(divmaq2);
                 ...
                 valores_aval_num_func[2]=newlaudosavaliacoes.get_Codigo_Setor(numocur);
                 buscar_registro(window,campos_aval_num_func,valores_aval_num_func,Array('=','=','='),'funcionarios','funcionarios','Sumarizar_Numero_Funcoes',false,newregistro);                 
                 tabeladefensivos_agriculas.rows[6].cells[1].children[0].value=newregistro.getValores();
                 divfuncdefensivos_agriculas=tabeladefensivos_agriculas.rows[8].cells[0].children[1];
                 divfunc=divfuncdefensivos_agriculas.children[0].cloneNode(true);
                 
                 buscar_registros(window,'laudos_avaliacoes_defensivos_agriculas_funcoes',"Carrega_Avaliacoes_defensivos_agriculas_funcoes",campos_aval_defensivos_agriculas,valores_aval_defensivos_agriculas,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_defensivos_agriculas_funcoes);
                 if (newlaudosavaliacoes_defensivos_agriculas_funcoes.length()>0) while (divfuncdefensivos_agriculas.children.length>0) divfuncdefensivos_agriculas.removeChild(divfuncdefensivos_agriculas.children[0]);
                 for (xs=0;xs<newlaudosavaliacoes_defensivos_agriculas_funcoes.length();xs++){
                     buscar_registro(window,Array('CODIGO_EMPRESA','CODIGO_FUNCAO'),Array(empresa_ativa,newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Codigo_funcao(xs)),Array('=','='),'funcoes','funcoes','Busca_Funcao',false,newfunc);
                     
                     divfunc2=divfunc.cloneNode(true);
                     
                     tabelafuncdefensivos_agriculas=divfunc2.children[0];
                     tabelafuncdefensivos_agriculas.rows[0].cells[0].children[0].length=0;
                     tabelafuncdefensivos_agriculas.rows[0].cells[0].children[0].add(new Option(newfunc.get_Descricao(),newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Codigo_funcao(xs)));
                     tabelafuncdefensivos_agriculas.rows[0].cells[0].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Codigo_funcao(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[1].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Periodicidade_exposicao(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[2].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Unidade(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[3].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Codigo_setor(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[4].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Grau_insalubridade(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[5].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Intensidade_concentracao(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[6].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Intensidade_concentracao_unidade(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[7].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Tecnica_utilizada(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[8].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Epc_eficaz(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[9].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Epi_eficaz(xs);
                     tabelafuncdefensivos_agriculas.rows[0].cells[10].children[0].value=newlaudosavaliacoes_defensivos_agriculas_funcoes.get_Ca_epi(xs);
                     divfuncdefensivos_agriculas.appendChild(divfunc2);
...
function exibir_historico_avaliacoes_poeiras_minerais(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_poeiras_minerais',"Carrega_Avaliacoes_poeiras_minerais",campos_aval_poeiras_minerais,valores_aval_poeiras_minerais,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_poeiras_minerais);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_poeiras_minerais.length();xs++){
                  ...
                  tabelapoeiras_minerais.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_poeiras_minerais.get_Texto_explicativo(xs);
                  ...
                  tabelapoeiras_minerais.rows[14].cells[1].children[0].value=newlaudosavaliacoes_poeiras_minerais.get_Grau_risco(xs);
                 }
...
function exibir_historico_avaliacoes_outros_quimicos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_outros_quimicos',"Carrega_Avaliacoes_outros_quimicos",campos_aval_outros_quimicos,valores_aval_outros_quimicos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_outros_quimicos);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_outros_quimicos.length();xs++){
                  ...
                  tabelaoutros_quimicos.rows[3].cells[0].children[0].children[0].value=newlaudosavaliacoes_outros_quimicos.get_Texto_explicativo(xs);
                  ...
                  tabelaoutros_quimicos.rows[14].cells[1].children[0].value=newlaudosavaliacoes_outros_quimicos.get_Grau_risco(xs);
                 }
       ...
       function popula_fotos_setores_historico_carregados(divatual){
           for (ncont=0;ncont<newlaudosetfoto.length();ncont++){
			...
			td.appendChild(divatual);
                        ...
                        divatual.getElementsByTagName('select')[7].value=newlaudosetper.get_Epc_Eficaz(numocur);
 ...
 function carregar_maquina_historico(){
            ...
            function carregar_atividade_epis_fornecidos_historico(codativ){
                        ...
                        if (newlaudoativepis.length()>0){
                            ...
                            linha_atual_epi.children[0].children[0].children[0].children[2].children[2].children[0].value=newlaudoativepis.get_Codigo_Atividade(0);
                            ...
                            linha_atual_epi.children[0].children[0].children[0].children[4].children[0].children[0].value=newlaudoativepis.get_Agente_Prevencao(0);
                            ...
                            while (cont<newlaudoativepis.length()){
                              ...
                              linha_atual_epi.children[0].children[0].children[0].children[2].children[2].children[0].value=newlaudoativepis.get_Codigo_Atividade(cont);
                              ...
                              linha_atual_epi.children[0].children[0].children[0].children[4].children[0].children[0].value=newlaudoativepis.get_Agente_Prevencao(cont);
                              cont++;
            ...
            function carregar_atividade_epis_necessarios_historico(codativ){
                        ...
                        if (newlaudoativepis.length()>0){
                            tabela_epis_c=divatual.getElementsByTagName('table')[3].cloneNode(true);
                            tabela_epis=divatual.getElementsByTagName('table')[3];
                            linhax=tabela_epis.rows[1];
                            linha_atual_epi=linhax;
                            ...
                            linha_atual_epi.cells[1].children[0].value=codativ;
                            linha_atual2=tabela_epis.rows[3];
                            linha_atual2.cells[0].children[0].value=newlaudoativepis.get_Agente_Prevencao(0);                            
                            //cont=1;
                            //txbody.appendChild(linhax);
                            while (cont<newlaudoativepis.length()){
                              
                              linha_atual_epi=tabela_epis_c.rows[1];
                              linha_atual_epi.cells[0].children[0].value=newlaudoativepis.get_Codigo_EPI(cont);
                              linha_atual_epi.cells[1].children[0].value=codativ;
                              linha_atual2=tabela_epis_c.rows[3];
                              linha_atual2.cells[0].children[0].value=newlaudoativepis.get_Agente_Prevencao(cont);                            
                              cont++;
                              divatual.appendChild(tabela_epis_c);
            ...
            function onselect_carrega_epis(campo){
                ...
                linha_nbr.rows[2].cells[2].children[0].value=vlcampo;
           ...
           function onselect_carrega_epis_necess(campo){
                ...
                divpai=linha_nbr.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode;
                vlcampo=divpai.children[0].rows[3].cells[1].children[0].value;
                linha_nbr.rows[1].cells[1].children[0].value=vlcampo;
			...
			function mostra_foto(campo){
				...
				document.getElementById('FOTO')[indice].src=campo.value;
                        ...
                        function imprimir_laudo(){
                            ...
                            window.open("../Reports/Laudos_Impressao2.php"+parm, "print", "location=no resizable=YES directories=no menubar=no status=no toolbar=no titlebar=no");   
                            }        
                        ...
                        function carrega_funcoes(campo){
                            divpai=campo.parentNode.parentNode.parentNode.parentNode;
                            ...
                            campo.length=0;
                            campo.add(new Option('',0));
                            for (y=1;y <=newfuncoeslaudo.length();y++){
                                  opt=new Option(newfuncoeslaudo.get_Descricao_funcao_empresa([y-1]),newfuncoeslaudo.get_Codigo_funcao([y-1]));
                                  campo.add(opt);
                            }
                            if (newfuncoeslaudo.length()==0){
                                  opt=new Option('NÃO HÁ FUNÇOES PARA ESSE SETOR','0');
                                  campo.add(opt);
                        ...
                        function formatText(el,tag){
                            txarea=el.parentNode;
                            txarea=txarea.getElementsByTagName('textarea')[0];
                            var selectedText = document.selection?document.selection.createRange().text:txarea.value.substring(txarea.selectionStart,txarea.selectionEnd);
                            if(selectedText!=''){
                                var newText='<'+tag+'>'+selectedText+'</'+tag+'>';
                                txarea.value=txarea.value.replace(selectedText,newText)
                            }
                        } 
        </script>
</head>
...
<td colspan="4"><div align="center">Texto Explicativo </div></td>
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify">
             <textarea name="laudos_avaliacoes_ruido|TEXTO_EXPLICATIVO[]" rows="10" cols="100"></textarea>
             <br/>
             <button type="button" value="Negrito"  onclick="formatText(this,'b')"><strong>N</strong>egrito</button>
             <button type="button" value="Itálico" onclick="formatText(this,'i')"><strong>I</strong>tálico</button>
             <button type="button" value="Sublinhado" onclick="formatText(this,'u')"><strong>S</strong>ublinhado</button>
               
                </div></td>
          </tr><tr><td><input type="hidden" id="CD_UNIDADE" name="laudos_avaliacoes_ruido|UNIDADE[]"/></td><td>
        ...
        <tr><td colspan="5">
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_ruido|GRAU_RISCO[]"  >
                    <option value=""></option>                        
...
<td colspan="4"><div align="center">Texto Explicativo </div></td>
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_ruido_dosimetria|TEXTO_EXPLICATIVO[]" rows="10" cols="100"></textarea></div></td>
          </tr>
 ...
 <tr><td >Nivel de Ruído atenuado</td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_ruido_dosimetria|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
	...
	<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_frio" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_frio|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
	 ...
	 <tr>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_frio|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_calor" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_calor|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
          <tr>
<td>
    ...
    <tr>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_calor|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_umidade" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_umidade|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_umidade|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_radiacao_nao_ionizante" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_radiacao_nao_ionizante|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr><td>
...
<td> 
        ...
        <!--Fim funções expostas ruído-->
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_radiacao_nao_ionizante|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_radiacao_ionizante" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_radiacao_ionizante|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
...
<td> 
        ...
        <!--Fim funções expostas ruído-->
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_radiacao_ionizante|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_outros_fisicos" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_outros_fisicos|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
                <td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_outros_fisicos|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_sangue_humano" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_sangue_humano|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
            <tr>
	  ...
	  <td><textarea name="laudos_avaliacoes_sangue_humano|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_sangue_humano|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_sangue_animal" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_sangue_animal|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
            <tr>
	  ...
	  <td><textarea name="laudos_avaliacoes_sangue_animal|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_sange_animal|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_manejo_animais" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_manejo_animais|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
            <tr>
	  ...
	  <td><textarea name="laudos_avaliacoes_manejo_animais|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_manejo_animais|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_outros_biologicos" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_outros_biologicos|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
                <td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_outros_biologicos|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_produtos_limpeza" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_produtos_limpeza|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
                      <td>
	  ...
	  <td><textarea name="laudos_avaliacoes_produtos_limpeza|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_produtos_limpeza|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_tintas_solventes" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_tintas_solventes|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
              <tr>
              <td>
	  ...
	  <td><textarea name="laudos_avaliacoes_tintas_solventes|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_tintas_solventes|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_hidrocarbonetos_aromaticos" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_hidrocarbonetos|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
              <td>
	  ...
	  <td><textarea name="laudos_avaliacoes_hidrocarbonetos|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_hidrocarbonetos|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_fumos_metalicos" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_fumos_metalicos|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
                      <td>
	  ...
	  <td><textarea name="laudos_avaliacoes_fumos_metalicos|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_fumos_metalicos|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_poeiras_incomodas" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_poeiras_incomodas|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
              <td>
	  ...
	  <td><textarea name="laudos_avaliacoes_poeiras_incomodas|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_poeiras_incomodas|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_poeiras_minerais" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_poeiras_minerais|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
	  ...
	  <td><textarea name="laudos_avaliacoes_poeiras_minerais|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_poeiras_minerais|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_defensivos_agriculas" style="display:none">
          <tr>
            <td colspan="4"><div align="center">Avalia&ccedil;&atilde;o de Agentes</div></td>
          </tr>
          <tr>
            <td colspan="4"><div align="center"></div></td>
            <td><input type="hidden" name="laudos_avaliacoes_defensivos_agriculas|TIPO_AVALIACAO[]"/></td>
          </tr>    
          <tr>
            <td colspan="4"><div align="center">Texto Explicativo </div></td>
          </tr>
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_defensivos_agriculas|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
         
              <tr>
              <td>
			  <input type="hidden" id="CD_UNIDADE" name="laudos_avaliacoes_defensivos_agriculas|UNIDADE[]"/></td><td>
			  <input type="hidden" id="CD_SETOR" name="laudos_avaliacoes_defensivos_agriculas|CODIGO_SETOR[]"/></td>
            ...
            <td >Periodicidade de exposi&ccedil;&atilde;o </td>	
              ...
              <td>
                          <select name="laudos_avaliacoes_defensivos_agriculas|PERIODICIDADE_EXPOSICAO[]" style="width:250px">
                  <option value="" selected="selected"></option>   
                  <option value="EVENTUAL">EVENTUAL</option>   
                  <option value="HABITUAL">HABITUAL</option>   
                  <option value="INTERMITENTE">INTERMITENTE</option>   
          ...
          <tr>
            <td width="17%">N&uacute;mero de Funcionários no setor</td>
            <td width="7%"><input type="text" name="laudos_avaliacoes_defensivos_agriculas|NUMERO_FUNCS_SETOR[]" size="6" readonly="readonly"/></td>
          </tr>
          <tr>
            <td width="17%">N&uacute;mero de Funcionários expostos no setor</td>
            <td width="17%"><input type="text" name="laudos_avaliacoes_defensivos_agriculas|NUMERO_FUNCS_EXPOSTOS[]" size="6" readonly="readonly""/></td>

          </tr>
          <tr>
              <td  colspan="5">
                              <table id="tbl_defensivos_agriculas_funcoes_cabec" style="background: appworkspace  ">
                                      <caption  style="background:whitesmoke"><strong>Lançamento de Funções Expostas no setor</strong></caption>      
                                      <tr>
                                          <td width="400px">Função</td>
                                          <td width="120px">Periodicidade de Exposi&ccedil;&atilde;o</td>
                                  ...
                                  <div style="background: appworkspace ">  
                                  <div id="div_defensivos_agriculas_funcoes_detalhes" style="width:100%;overflow:auto" style="background: appworkspace "> 
                                  <table id="tbl_defensivos_agriculas_funcoes_detalhes" style="background: appworkspace ">
                                          <tr>
                                              <td >
                                                      <select name="laudos_avaliacoes_defensivos_agriculas_funcoes|CODIGO_FUNCAO[]" style="width:400px" onfocus="carrega_funcoes(this)" onchange="onchange_funcoes(this)">
                                                      </select>
                                               </td>
                                              <td>
                                                      <select name="laudos_avaliacoes_defensivos_agriculas_funcoes|PERIODICIDADE_EXPOSICAO[]" style="width:120px;text-transform:none">
                                                        <option value="" selected="selected"></option>   
                                                        <option value="EVENTUAL">EVENTUAL</option>   
                                                        <option value="HABITUAL">HABITUAL</option>   
                                                        <option value="INTERMITENTE">INTERMITENTE</option>   
                                                  ...
                                                  <td width="0"><input type="hidden" name="laudos_avaliacoes_defensivos_agriculas_funcoes|UNIDADE[]"/></td>
                                                  <td width="0"><input type="hidden" name="laudos_avaliacoes_defensivos_agriculas_funcoes|CODIGO_SETOR[]"/></td>
                                              
                                              <td width="150px">
                                                  <select name="laudos_avaliacoes_defensivos_agriculas_funcoes|GRAU_INSALUBRIDADE[]" >
                                                      <option value=""></option>
                                                      <option value="MINIMO">M&Iacute;NIMO</option>
                                                      <option value="MÉDIO">M&Eacute;DIO</option>
                                                      <option value="MÁXIMO">M&Aacute;XIMO</option>
                                              ...
                                              <td width="120px">
                                                  <input name="laudos_avaliacoes_defensivos_agriculas_funcoes|INTENSIDADE_CONCENTRACAO[]" size="15"/>
                                              </td>
                                              <td width="50px">
                                                  <input name="laudos_avaliacoes_defensivos_agriculas_funcoes|INTENSIDADE_CONCENTRACAO_UNIDADE[]" size="10"/>
                                              </td>
                                              <td width="250px">
                                                  <input name="laudos_avaliacoes_defensivos_agriculas_funcoes|TECNICA_UTILIZADA[]" size="30" maxsize="40"/>
                                              </td>
                                              <td width="100px">
                                                  <select name="laudos_avaliacoes_defensivos_agriculas_funcoes|EPC_EFICAZ[]" >
                                                      <option value=""></option>
                                                      <option value="S">SIM</option>
                                                      <option value="N">N&Atilde;O</option>
                                                  </select>
                                              ...
                                              <td width='100px'>
                                                  <select name="laudos_avaliacoes_defensivos_agriculas_funcoes|EPI_EFICAZ[]" >
                                                      <option value=""></option>
                                                      <option value="S">SIM</option>
                                                      <option value="N">N&Atilde;O</option>
                                                  </select>
                                              ...
                                              <td width="100px">
                                                  <input name="laudos_avaliacoes_defensivos_agriculas_funcoes|CA_EPI[]" size="10"/>
                                              </td>
                                                  </tr>
                                      </table>
                                    <button type="button" onclick="insere_funcao_avaliacao(this)">+Inserir Registro</button>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div id="div_maq_equip_defensivos_agriculas" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
                                      <td><input type="hidden" id="CD_UNIDADE" name="laudos_avaliacoes_defensivos_agriculas_maquinas|UNIDADE[]" size="0"/></td><td>
			  <input type="hidden" id="CD_SETOR" name="laudos_avaliacoes_defensivos_agriculas_maquinas|CODIGO_SETOR[]" size="0"/></td>
                                        
                                      <td  width="49%"  ><select name="laudos_avaliacoes_defensivos_agriculas_maquinas|CODIGO_MAQUINA[]" onfocus="carregar_maquinas_equipamentos(this)" onchange="onselect_avaliacoes_maquinas(this)" onfocus="carregar_maquinas_equipamentos(this)" onchange="onselect_avaliacoes_maquinas(this)" style="width:90%"></select></td>
                                      <td width="35%"  ><input type="text" name="laudos_avaliacoes_defensivos_agriculas_maquinas|NIVEL_MEDIDO[]" value="0" onkeypress="return valida_decimal(this,event)" onblur="formata_decimal_casas(this,'eu',1)"/></td>
                                      <td width="28%" ><input type="text" name="laudos_avaliacoes_defensivos_agriculas_maquinas|NIVEL_PERMITIDO[]" value="0" onkeypress="return valida_decimal(this,event)" onblur="formata_decimal_casas(this,'eu',1)"/></td>
                                    </tr>         
                                </table>
                                <button type="button" onclick="insere_maquina(this)">+Inserir Registro</button>
                                <button type="button" onclick="remove_maquina(this)">-Remover Registro</button>
                    ...
                    <tr><td>
                     Medidas de Proteção Coletivas Adotadas   
                        ...
                        <td><select name="laudos_avaliacoes_defensivos_agriculas|MEDIDAS_PROTECAO_COLETIVA[]">
                          <option value="" selected="selected"></option>   
                          <option value="NH">Nenhuma</option>   
                          <option value="IT">Isolamento T&eacute;rmico</option>   
                          <option value="OT">Outros</option>   
                        ...
                        <input type="text" name="laudos_avaliacoes_defensivos_agriculas|MEDIDAS_PROTECAO_COLETIVA_OUTROS[]"/></td>
                    </tr>           
                    <tr><td>
                     Medidas de Proteção Individuais Adotadas   
                     </td>
                        <td><select name="laudos_avaliacoes_defensivos_agriculas|MEDIDAS_PROTECAO_INDIVIDUAL[]">
                          <option value="" selected="selected"></option>   
                          <option value="NH">Nenhuma</option>   
                          <option value="PAP">Protetor tipo jaqueta t&eacute;rmica</option>   
                          <option value="PAC">Botas Térmicas</option>   
                        ...
                        <input type="text" name="laudos_avaliacoes_defensivos_agriculas|MEDIDAS_PROTECAO_INDIVIDUAL_OUTROS[]"/></td>
                    </tr>           
              
    
        <tr>
	  <td >Fonte geradora</td>
	  <td><textarea name="laudos_avaliacoes_defensivos_agriculas|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
	  </tr>	

          <tr>
            <td>Enquadramento</td>
            <td colspan="3"><textarea name="laudos_avaliacoes_defensivos_agriculas|ENQUADRAMENTO[]" cols="145" rows="5"></textarea></td>
          </tr>
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_defensivos_agriculas|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_iluminamento" style="display:none">
          ...
          <tr>
            <td colspan="4"><div style="text-align:justify"><textarea name="laudos_avaliacoes_iluminamento|TEXTO_EXPLICATIVO[]" cols="145" rows="5"></textarea></div></td>
          </tr>
    <tr>
    ...
    <tr></tr>
	  ...
	  <td><textarea name="laudos_avaliacoes_iluminamento|FONTE_GERADORA[]" cols="120" rows="5"></textarea></td>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_iluminamento|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_outros_quimicos" style="display:none">
    ...
    <tr>
          ...
          <tr>
            <td >Grau de Risco</td>
            <td colspan="2">
                <select name="laudos_avaliacoes_outros_quimicos|GRAU_RISCO[]"  >
                    <option value=""></option>                        
                    <option value="MÍNIMO">MÍNIMO</option>    
                    <option value="MÉDIO">MÉDIO/CONTROLADO</option>
                    <option value="ALTO">ALTO SEM PROTEÇÃO</option>
...
<div id="entrada_setores" style="display:none" >
            ...
            <div id="div_setor"  style="overflow:hidden">
              <table width="90%" border="0" class="tabela" >
                ...
                <tr>
                  ...
                  <tr>
                  <td>Possui E.P.C. Eficaz?</td><td><select name="laudos_setores_pericia|EPC_EFICAZ[]" >
                          <option value=""></option>
                ...
                <tr>
                  <td colspan="2" ><div align="center"><h3>Fotos</h3> </div></td>
                
                </tr>
            	<tr>
                    <table id="tbl_foto" >
                        <caption>Fotos Provenientes da Perícia</caption>
                        <tr>	
        		<td>
                            <div id="div_foto">
                                <table>
		...
		<tr>
			   ...
			   <tr><td><input type="text" name="laudos_atividades_funcoes|CODIGO_FUNCAO[]" readonly="readonly" style="width:50px" value=""/>
                     ...
                     <tr id="epi_neces">
                         ...
                         <table id="epis_necess">    
                             <caption>EPIs necess&aacute;rios para realiza&ccedil;&atilde;o da atividade com seguran&ccedil;a </caption>   
                         <tr> 
                            <td olspan="3"><button type="button" value="" onclick="insere_epis(this)">+ Incluir EPIs</button></td>
                        </tr>
                        <tr>
			  ...
			  <input type="hidden" id="CODIGO_ATIVIDADE" name="laudos_epis_necessarios|CODIGO_ATIVIDADE[]" size="0"/>
                            ...
                            <tr><td><label>Agente de Prevenção</label></td></tr>
                            <tr>
                            <td>
                            <select name="laudos_epis_necessarios|AGENTE_PREVENCAO[]" style="width:400px" >
                                <option value=""></option>
                                <option value="CALOR">CALOR</option>
                                <option value="FRIO">FRIO</option>
                                <option value="FUMOS_METALICOS">FUMOS METÁLICOS</option>                                
                                <option value="HIDROCARBONETOS">HIDROCARBONETOS AROMÁTICOS</option>                                
                                <option value="MANEJO DE ANIMAIS">MANEJO DE ANIMAIS</option>
                                <option value="OUTROS_BIOLOGICOS">OUTROS BIOLÓGICOS</option>
                                <option value="OUTROS_FISICOS">OUTROS FÍSICOS</option>
                                <option value="OUTROS_QUIMICOS">OUTROS QUÍMICOS</option>
                                <option value="POEIRAS_INCOMODAS">POEIRAS INCÔMODAS</option>
                                <option value="POEIRAS_MINERAIS">POEIRAS MINERAIS</option>
                                <option value="PRODUTOS_LIMPEZA">PRODUTOS DE LIMPEZA</option>
                                <option value="RADIACAO_IONIZANTE">RADIAÇÃO IONIZANTE</option>
                                <option value="RADIACAO_NAO_IONIZANTE">RADIAÇÃO NÃO IONIZANTE</option>
                                <option value="RUIDO">RUÍDO</option>
                                <option value="RUIDO_DOSIMETRIA">RUÍDO DOSIMETRIA</option>
                                <option value="SANGUE_HUMANO">SANGUE_HUMANO</option>
                                <option value="SANGUE_ANIMAL">SANGUE_ANIMAL</option>
                     ...
                     <table id="tbl_epis_fornecidos"width="100%" >
                         <caption>EPIs fornecidos pela empresa para o exerc&iacute;cio da atividade </caption>
                      <tr id="epi_forn">
		          ...
		          <td>
                          ...
                          <tr>    
                            ...
                            <td width="138"><button type="button" value="" onclick="window.open('http://localhost/ELC2012/HTML/epis.php', 'pagina' ,' STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1050, HEIGHT=500');" >+ Cadastrar EPIs</button></td>
                          </tr>
                          <tr>
                            <td width="407">EPI</td>
                            <td width="68">C.A.</td>
			    <td colspan="3"><button type="button" value="" onclick="insere_epis(this)">+ Incluir EPIs</button></td>	
                          </tr>
                          <tr>
                            ...
                            <tr><td><label>Agente de Prevenção</label></td></tr>
                            <tr><td>
                            <select name="laudos_epis_fornecidos|AGENTE_PREVENCAO[]" style="width:400px" >
                                <option value=""></option>
                                <option value="CALOR">CALOR</option>
                                <option value="FRIO">FRIO</option>
                                <option value="FUMOS_METALICOS">FUMOS METÁLICOS</option>                                
		...
		<tr>
		  ...
		  <td colspan="3"><select name="laudos_avaliacoes|CODIGO_SETOR[]" style="width:250px" onfocus="carrega_setores(this)">
			  ...
			  <input type="hidden" name="laudos_avaliacoes|OUTROS_QUIMICOS[]" value="0"   onclick="registrar_fator(this)"/>
                            ...
                            <input type="checkbox" name="laudos_avaliacoes|DEFENSIVOS_AGRICOLAS[]" value="1" id="DEFENSIVOS_AGRICOLAS"  onclick="registrar_fator(this)"/>
                            <input type="hidden" name="laudos_avaliacoes|DEFENSIVOS_AGRICOLAS[]" value="0"   onclick="registrar_fator(this)"/>   
