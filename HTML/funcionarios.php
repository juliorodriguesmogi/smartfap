...
//                        tr.appendChild(td);
        ...
        function exibe_campos(){
            ...
            function grava_registro(){
             if (confirm("Confirma a manutenção do registro?")){
...
<form id="frm_funcionarios" action="empresas.php" method="POST">
  ...
  <div id="divDocumentacao" style="display: block">
		...
		<button type="button" onclick="insere(this)" id="insere_historico_afastamento">+ Incluir Histórico</button>		
		<button type="button" onclick="remove(this)">- Remover Histórico</button>		
        ...
        <div id="divHistoricoFuncoes" style="display: block;overflow:auto;height:500px" >
            ...
            <table border="0" width="100%" bgcolor="WHITESMOKE" >
			  ...
			  <tr>
       		...
       		<button type="button" onclick="insere(this)" id="insere_historico_lotacao">+ Incluir Histórico</button>		
    		<button type="button" onclick="remove(this)">- Remover Histórico</button>		
        </div>      
    ...
    <table border="0" width="95%" bgcolor="WHITESMOKE" class="tabela">
                <tr>
                    ...
                    <td width="10%">
                       Resultado</td>                    
                    <td width="10%">
                      Data do Próximo Exame</td>
                    <td width="10%">
                      Profissional Responsável</td>        
                    <td width="10%">
                      NIT Profissional Responsável</td>                    
                ...
                <tr>
                  ...
                  <td><select name="funcionarios_historico_exames|RESULTADO[]">
        		    <option value=""></option>
                            ...
                            <option value="ES">Estável</option>
                            <option value="AG">Agravamento</option>
                            <option value="OC">Ocupacional</option>
                            <option value="NO">Não-Ocupacional</option>
                      </select></td>
       		...
       		<button type="button" onclick="insere(this)" id="insere_historico_exames">+ Incluir Histórico</button>		
    		<button type="button" onclick="remove(this)" id="remove_historico_exames">- Remover Histórico</button>		
...
<div id="divMonitoracaoBiologica" style="display: block;overflow:auto;height:500px">
    ...
    <table border="0" width="95%" bgcolor="WHITESMOKE" class="tabela">
       		...
       		<button type="button" onclick="insere(this)" id="insere_monitoracao_biologica">+ Incluir Histórico</button>		
    		<button type="button" onclick="remove(this)" id="remove_monitoracao_biologica">- Remover Histórico</button>		
    ...
    <table border="0" width="95%" bgcolor="WHITESMOKE" class="tabela">
                <tr>
                    ...
                    <td width="10%">
                       Data final                    </td>
                    <td width="80%">
                       Descrição Resumida da Atividade       </td>
                    <td width="80%">
                       Descrição Completa da Atividade       </td>
       		...
       		<button type="button" onclick="insere(this)" id="insere_historico_profissiografia">+ Incluir Histórico</button>		
    		<button type="button" onclick="remove(this)" >- Remover Histórico</button>		
    ...
    <table border="0" width="99%" bgcolor="WHITESMOKE" class="tabela">
                <tr>
                    ...
                    <td width="11%">
                       Fator de Risco                    </td>
                    <td width="18%">
                       Intensidade/Concentração                    </td>
                    <td width="32%">
                       Técnica Utilizada                    </td>
                    <td width="7%">
                       EPC Eficaz                    </td>
                    <td width="5%">
                       EPI Eficaz                    </td>
		    ...
		    <option value="RADIACAO_NAO_IONIZANTE">RADIAÇÃO NÃO IONIZANTE</option>                    
                    ...
                    <option value="HIDROCARBONETOS_AROMATICOS">HIDROCARBONETOS AROMÁTICOS</option>                    
      		...
      		<button type="button" onclick="insere(this)">+ Incluir Histórico</button>		
    		<button type="button" onclick="remove(this)">- Remover Histórico</button>		
</div>      
