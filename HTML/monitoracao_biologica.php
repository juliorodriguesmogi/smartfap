...
<center><h1>Monitoração Biologica</h1></center>
    ...
    <form id="frm_maquina" action="" method="POST">
        ...
        <div id="divCadastro" style="display: block">
          ...
          <td width="53"><div align="right">Area de Atuação </div></td>
    ...
    <button type="button" onclick="insere(this)">+ Incluir Monitoração</button>		
		<button type="button" onclick="remove(this)">- Remover Monitoração</button>
    </form>
