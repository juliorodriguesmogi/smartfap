...
<script type="text/javascript" src="../classes/js/Mpcmsos_responsaveis.js"></script>
...
<script type="text/javascript" src="../classes/js/MLaudos_Tipos_Avaliacoes.js"></script>
<script type="text/javascript" src="../classes/js/Mpcmsos_agentes_identificados_funcoes.js"></script>
<script type="text/javascript" src="../classes/js/Mpcmsos_cronograma_prioridade.js"></script>
<script type="text/javascript" src="../classes/js/Mpcmsos_profissionais.js"></script>
<script type="text/javascript" src="../classes/js/Mpcmsos_responsaveis.js"></script>
<script type="text/javascript" src="../classes/js/Mpcmsos_riscos_identificados.js"></script>
<script type="text/javascript" src="../classes/js/Mpcmsos_setores_agentes.js"></script>
<link href="../css/designer.css" type="text/css" rel="stylesheet" />    
<link href="estilosistema.css" type="text/css" rel="stylesheet" />
		...
		divpai.removeChild(tblpai);
            ...
            function pesquisar_laudo(){
                ...
                campos[3]="REVISAO";
                valores=Array();
                valores[0]=document.forms[1].elements['pcmsos|CODIGO_EMPRESA'].value;
                valores[1]=document.forms[1].elements['pcmsos|ANO_PERICIA'].value;
                valores[2]=document.forms[1].elements['pcmsos|NUMERO_LAUDO'].value;
                valores[3]=document.forms[1].elements['pcmsos|REVISAO'].value;
                buscar_registro(window,campos,valores,Array('=','=','=','='),'pcmsos_responsaveis','pcmsos_responsaveis','Busca_pcmsos_responsaveis',false,newlaudoacompanhantes);                                    
	   ...
	   function carrega_unidades(campo){
		 ...
		 campo.add(new Option('',0));
          ...
          function exibe_campos(){
                numero_laudo=document.forms[1].elements['pcmsos|NUMERO_LAUDO'].value;
                ano_pericia=document.forms[1].elements["pcmsos|ANO_PERICIA"].value;
                revisao=document.forms[1].elements["pcmsos|REVISAO"].value;
                document.forms[1].reset();
                //newmaquina.setValores(newregistro.getValores());
                                
                if (acao=='I'){
                    document.forms[1].elements["pcmsos|NUMERO_LAUDO"].value = numero_laudo;
                    document.forms[1].elements["pcmsos|ANO_PERICIA"].value = ano_pericia;
                    document.forms[1].elements["pcmsos|REVISAO"].value = revisao;
                }
                
                if (acao=='A'){
                        
                        document.forms[1].elements["pcmsos|ANO_PERICIA"].value = new String(newlaudo.get_Ano_Pericia());
                        document.forms[1].elements["pcmsos|NUMERO_LAUDO"].value = new String(newlaudo.get_Numero_Laudo());
                        document.forms[1].elements["pcmsos|REVISAO"].value = new String(newlaudo.get_Revisao());
                        document.forms[1].elements["pcmsos|DATA_LANCAMENTO"].value = new String(newlaudo.get_Data_Criacao().toString().substr(0,10));
			document.forms[1].elements["pcmsos|DATA_HORA_PERICIA"].value = new String(newlaudo.get_Data_Pericia());
                        document.forms[1].elements["pcmsos|SITUACAO_LAUDO"].value = new String(newlaudo.get_Situacao());
                        document.forms[1].elements["pcmsos|ENDERECO_ATUACAO"].value = new String(newlaudo.get_Endereco());
                        document.forms[1].elements["pcmsos|BAIRRO_ATUACAO"].value = new String(newlaudo.get_Bairro());    
                        document.forms[1].elements["pcmsos|MUNICIPIO_ATUACAO"].value = new String(newlaudo.get_Municipio());    
                        document.forms[1].elements["pcmsos|CEP_ATUACAO"].value = new String(newlaudo.get_CEP());                
                        document.forms[1].elements["pcmsos|UF_ATUACAO"].value = new String(newlaudo.get_UF());                     
                        document.forms[1].elements["pcmsos_responsaveis|FUNCAO"].value = new String(newlaudoacompanhantes.get_Funcao());
                        document.forms[1].elements["pcmsos_responsaveis|NOME_RESPONSAVEL"].value = new String(newlaudoacompanhantes.get_Responsavel_laudoxxx());
                        document.forms[1].elements["pcmsos_responsaveis|DATA_ADMISSAO"].value = new String(newlaudoacompanhantes.get_Data_Admissao_laudo());             
                        campos=Array();
                        campos[0]="CODIGO_EMPRESA";
                        campos[1]="ANO_PERICIA";
                        campos[2]="NUMERO_LAUDO";
            ...
            function carregar_setores_agentes(){
                    ...
                    if (divpai.children.length>1){
                       if (divpai.children[1].id=='div_setores_agentes'){
                        ...
                        buscar_registros(window,'','Carrega_Setores_Agentes_pcmso',campos,valores,true,Array("=","=","=","="),newpprassetores_agentes);
                        for (contador1=0;contador1<newpprassetores_agentes.length();contador1++){
                                ...
                                do{
                                  ...
                                  buscar_registros(window,'laudos_avaliacoes_'+newpprassetores_agentes.get_Tipo(contador1).toLowerCase(),'Carrega_Setores_Agentes_Funcoes_pcmso',campos_funcoes,valores_funcoes,true,Array("=","=","=","=","=","="),newpprasagentes_identificados_funcoes);
...
function captura_linha_instrumentos(ttr){
            ...
            function captura_linha_responsavel(ttr){
                valor_celula=captura_valores(ttr);
                document.forms[1].elements['pcmsos_responsaveis|NOME_RESPONSAVEL'].value=valor_celula[0];
                document.forms[1].elements['pcmsos_responsaveis|FUNCAO'].value=valor_celula[1];
                document.forms[1].elements['pcmsos_responsaveis|DATA_ADMISSAO'].value=valor_celula[2];
                document.forms[1].elements['pcmsos_responsaveis|NOME_RESPONSAVEL'].focus();
                document.getElementById('consultaexterna').style.display='none';
            }
         ...
         empresa_ativa=empresa_ativa.toString();
            ...
            function captura_linha_tecnico(ttr){
                valor_celula=captura_valores(ttr);
                document.forms[1].elements['pcmsos_profissionais|NOME_RESPONSAVEL[]'][0].value=valor_celula[0];
                document.forms[1].elements['pcmsos_profissionais|FUNCAO[]'][0].value=1;
                document.forms[1].elements['pcmsos_profissionais|NOME_RESPONSAVEL[]'][0].focus();
                document.getElementById('consultaexterna').style.display='none';
            }

            function captura_linha_engenheiro(ttr){
                valor_celula=captura_valores(ttr);
                document.forms[1].elements['pcmsos_profissionais|NOME_RESPONSAVEL[]'][1].value=valor_celula[0];
                document.forms[1].elements['pcmsos_profissionais|FUNCAO[]'][1].value=2;
                document.forms[1].elements['pcmsos_profissionais|NOME_RESPONSAVEL[]'][1].focus();
                document.getElementById('consultaexterna').style.display='none';
            }
         ...
         empresa_ativa=empresa_ativa.toString();
            ...
            function captura_linha_laudo(ttr){
                valor_celula=captura_valores(ttr);
                document.forms[1].elements['pcmsos|ANO_PERICIA'].value=valor_celula[0];
                document.forms[1].elements['pcmsos|NUMERO_LAUDO'].value=valor_celula[1];
                document.forms[1].elements['pcmsos|RAZAO_SOCIAL'].value=valor_celula[2];
                document.forms[1].elements['pcmsos|ANO_PERICIA'].focus();
                document.getElementById('consultaexterna').style.display='none';
            }
         ...
         empresa_ativa=empresa_ativa.toString();
            ...
            function consultar_laudo(ntabela,campo_pesquisa,criterio){
                ...
                empresa_ativa=empresa_ativa.toString();
                parm=Array(empresa_ativa,(campo_pesquisa.value));
                buscar_registros(window,'laudos','Consulta_numero_laudo',Array("pcmsos|CODIGO_EMPRESA","pcmsos|NUMERO_LAUDO"),parm,false,Array("=","like "),newregistros);
            ...
            function monta_consulta_pcmso(campo_origem,campo_pesquisa){
               empresa_ativa=<?php echo $_SESSION['empresa_ativa']?>+0;        
         empresa_ativa=empresa_ativa.toString();
              ...
              estilo='';
                ...
                consultar_pcmso(tabela,campo_pesquisa,' like ')
            }    
                
                
            function consultar_pcmso(ntabela,campo_pesquisa,criterio){
                tbody=document.createElement('tbody');
                tbody.setAttribute('class','scrollContent');
                ntabela.appendChild(tbody);
                empresa_ativa=empresa_ativa.toString();
                parm=Array(empresa_ativa,(campo_pesquisa.value));
                buscar_registros(window,'ppras','Consulta_numero_pcmso',Array("pcmsos|CODIGO_EMPRESA","pcmsos|NUMERO_pcmso"),parm,false,Array("=","like "),newregistros);
                ...
                for(x=0;x<valores.length-1;x++){
                    ...
                    for (y=0;y<vreg.length-1;y++){
                        ...
                        function carrega_campos_iniciais(){
                            if (document.forms[1].elements['pcmsos|ANO_PERICIA'].value=="") 
                            document.forms[1].elements['pcmsos|ANO_PERICIA'].value=new Date().getFullYear();
                            if (document.forms[1].elements['pcmsos|DATA_LANCAMENTO'].toString().length==0) 
                            document.forms[1].elements['pcmsos|DATA_LANCAMENTO'].value=retorna_data_hoje();
                            if (document.forms[1].elements['pcmsos|REVISAO'].value=="") 
                            document.forms[1].elements['pcmsos|REVISAO'].value="0";                            
                            if (document.forms[1].elements['pcmsos|SITUACAO_LAUDO'].value==" ") 
                            document.forms[1].elements['pcmsos|SITUACAO_LAUDO'].value="Iniciado";    
                            sequencial_foto=Array(Array());
                            
                        }
                        
                        function imprimir_pcmso(){
                            ano_pericia=document.forms[1].elements['pcmsos|ANO_PERICIA'].value;
                            numero_pcmso=document.forms[1].elements['pcmsos|NUMERO_pcmso'].value;
                            empresa_ativa=<?php echo $_SESSION['empresa_ativa']?>+0;        
                            empresa_ativa=empresa_ativa.toString();  
                            
                            if (confirm("Imprimir registro?")){                
   
                            parm="?CODIGO_EMPRESA="+empresa_ativa+"&ANO_PERICIA="+ano_pericia+"&NUMERO_pcmso="+numero_pcmso;
...
<body onload="carrega_campos_iniciais()" >
    ...
    <center>
      <h1>Gera&ccedil;&atilde;o  de Programa de Controle M&eacute;dico de Sa&uacute;de Ocupacional </h1>
    </center>
    <div id="divprin">
        <form id="frm_barra_tarefas" action="" >
          ...
          <table>
             ...
             <button  type="button" onclick="imprimir_pcmso();">
             <table>
                  <tr>
	...
	<div style="overflow:auto ">
        <table width="70%" border="0" cellpadding="0" cellspacing="1">
            <tr>
                ...
                <td width="10%" height="36" align="center" valign="middle" class="abainativa" id="celAbaCronograma" onClick="trataCliqueAba( this.id );" onMouseOver="trataMouseAba( this );">
                    Riscos e Exames por Função</td>
                
            </tr>    
        </table>    
        <form action="" method="POST"  id="frm_pcmsos">
            <div id="divDadosEmpresa" style="overflow:auto;height:60%;min-height:60%;" >
                <table width="90%" border="0" class="tabela" >
                <tr>
                <td width="70">Código da Empresa </td>
                <td width="62"><input type="text" name="pcmsos|CODIGO_EMPRESA" maxlength="10" size="10" readonly="readonly" value="<?php echo $_SESSION['empresa_ativa']?>"/></td>
                <td colspan="2">Nome da Empresa</td>
                <td colspan="4"><input type="text" name="pcmsos|RAZAO_SOCIAL" readonly="readonly"  maxlength="50" size="50" value="<?php echo ($_SESSION['nome_empresa_ativa']) ?>"/></td>
                <td>CNPJ/C.E.I</td>
                <td colspan="2">&nbsp;</td>
                <td width="39">C.NA.E</td>
                <td width="62"><input type="text" name="pcmsos|CNAE" readonly="readonly" size="10" value="<?php echo $_SESSION['cnae_empresa_ativa'] ?>" /></td>
                <td width="77">Grau de Risco </td>
                <td width="13"><input name="pcmsos|GRAU_RISCO" type='text' readonly="readonly" size="1" value="<?php echo $_SESSION['grau_risco_empresa_ativa'] ?>" /> </td>
                <td width="30">No. Func </td>
                <td width="94"><input type="text" name="pcmsos|NRO_FUNCS" maxlength="10" size="10" readonly="readonly" value="<?php echo $_SESSION['numero_funcs_empresa_ativa'] ?>" /></td>
              </tr>
              <tr>
                <td> Ano da Per&iacute;cia</td>
                <td><input type="text" name="pcmsos|ANO_PERICIA" maxlength="4" size="5"  onkeypress="return entrada_numerica_inteira(this,event)"  /></td>
                <td width="48">N&uacute;mero do PCMSO </td>
                <td width="62"><input type="text" name="pcmsos|NUMERO_pcmso" maxlength="10" size="10" onkeypress="return entrada_numerica_inteira(this,event)" />
                <img src="../images/search.png" onclick="monta_consulta_pcmso(document.forms[1].elements['pcmsos|NUMERO_pcmso'],document.forms[1].elements['pcmsos|NUMERO_pcmso'])" width="10px" height="10px"/></td>
                <td width="73">Data Lan&ccedil;amento PPRA</td>
                <td width="65"><input type="text" name="pcmsos|DATA_LANCAMENTO_pcmso" maxlength="10" size="10" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)"/></td>
                <td width="74">N&uacute;mero do Laudo Origem</td>
                <td width="84"><input type="text" name="pcmsos|NUMERO_LAUDO" maxlength="10" size="10" onkeypress="return entrada_numerica_inteira(this,event)" />
                <img src="../images/search.png" onclick="monta_consulta_laudo(document.forms[1].elements['pcmsos|NUMERO_LAUDO'],document.forms[1].elements['pcmsos|NUMERO_LAUDO'])" width="10px" height="10px"/></td>
                <td width="66">Revis&atilde;o Laudo Origem</td>
                <td width="21"><input type="text" name="pcmsos|REVISAO" maxlength="2" size="2"  onkeypress="return entrada_numerica_inteira(this,event)"  onblur="pesquisar_laudo()" /></td>
                <td width="57">N&uacute;mero do PPRA Origem </td>
                <td colspan="2"><input type="text" name="pcmsos|DATA_LANCAMENTO_LAUDO" maxlength="10" size="10" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)"/></td>
                <td colspan="2">Data/Hora da Per&iacute;cia</td>
                <td colspan="2"><input type="text" name="pcmsos|DATA_HORA_PERICIA" maxlength="19" size="19"  onkeyup="return formata_data_hora(this,'eu_dh',event);" onkeypress="return valida_data_hora(this,event)"/></td>
                </tr>
           </table>
            ...
            <tr>
                ...
                <td colspan="4"><input type="text" readonly="readonly" name="pcmsos|ENDERECO_ATUACAO" maxlength="100" size="100" value="<?php echo ($_SESSION['endereco_empresa_ativa']) ?>" /></td>
			 </tr>
			 <tr>
               <td width="126">Bairro</td>
               <td width="237"><input type="text" name="pcmsos|BAIRRO_ATUACAO" SIZE="30" readonly="readonly" value="<?php echo ($_SESSION['bairro_empresa_ativa']) ?>" /></td>
                <td width="104">Municipio</td>
                <td width="267"><input type="text" name="pcmsos|MUNICIPIO_ATUACAO" SIZE="30" readonly="readonly" value="<?php echo ($_SESSION['municipio_empresa_ativa']) ?>"   /></td>
                <td width="68">CEP</td>
                <td width="73"><input type="text" name="pcmsos|CEP_ATUACAO" readonly="readonly" sIZE="10" value="<?php echo $_SESSION['cep_empresa_ativa'] ?>" /></td>
                <td width="21">UF</td>
                <td width="223"><input type="text" name="pcmsos|UF_ATUACAO" readonly="readonly" size="2" value="<?php echo $_SESSION['uf_empresa_ativa'] ?>" /></td>
			 </tr>
          </table>
      </div>
		...
		<td colspan="2" width="338"><input type="text" name="pcmsos_profissionais|NOME_RESPONSAVEL[]" maxlength="40" size="35"/> <img src="../images/search.png" onclick="monta_consulta_tecnicos(document.forms[1].elements['pcmsos_profissionais|NOME_RESPONSAVEL[]'][0],document.forms[3].elements['txt_pesquisa'])" width="10px" height="10px"/>		  </td>
                <td  width="338"><input type="hidden" name="pcmsos_profissionais|FUNCAO[]" maxlength="40" size="35" value="1"/> </td>
              </tr>
    </table>                    
            <table width="90%" border="0" class="tabela" >
		<tr>
		<td width="86">Nome  do Engenheiro de Segurança</td>
                <td colspan="2" width="338"><input type="text" name="pcmsos_profissionais|NOME_RESPONSAVEL[]" maxlength="40" size="35"/> <img src="../images/search.png" onclick="monta_consulta_engenheiros(document.forms[1].elements['pcmsos_profissionais|NOME_RESPONSAVEL[]'][1],document.forms[3].elements['txt_pesquisa'])" width="10px" height="10px"/>		  </td>
                <td  width="338"><input type="hidden" name="pcmsos_profissionais|FUNCAO[]" maxlength="40" size="35" disabled value="2"/> </td>
              </tr>
    </table>                    
     </div>        
        ...
        <div id="div_statusbar">
          <form id='status' name="status">
            ...
            <input type="text" name="pcmsos|CNPJ_CEI" readonly="readonly" value="<?php echo $_SESSION['cnpj_empresa_ativa'] ?>" />
          </form>
        </div>
        <form>
...
<div id="div_setores_agentes" style="display:none;overflow:auto">
  <div id="div_grupo_setores">
      <table width="98%">
	  <caption>Grupos de Setores e Funções</caption>
  <tr>
  <td width="23%" >Grupo de Setores</td>
  <td width="11%"  align="center">Número de Funcionários</td>
  <td width="66%"  align="center">Funções</td>
  </tr>
  <tr>
    <td><input type="text" name="pcmsos_riscos_setores|CLASSIFICACAO_SETOR[]"   size="30"/></td>
    <td><input type="text" name="pcmsos_riscos_setores|NUMERO_FUNCIONARIOS[]" size="10" maxlength="10" /></td>
    <td><textarea  name="pcmsos_riscos_setores|funcoes|DESCRICAO_FUNCOES[]" rows="5" cols="50"> </textarea></td>
  </tr>
  </table>
  </div>
  <div id="div_grupo_setores">
      <table width="98%">
	  <caption>Riscos e Exames por Função</caption>
  <tr>
  <td width="23%" >Função</td>
  <td width="11%"  align="center">Período</td>
  <td width="66%"  align="center">Riscos</td>
  <td width="66%"  align="center">Exames Complementares</td>
  </tr>
  <tr>
    <td><select  name="pcmsos_riscos_setores|CODIGO_FUNCAO[]" ></select></td>
    <td><input type="text" name="pcmsos_riscos_setores|PERIODO[]" size="10" maxlength="10" /></td>
    <td><textarea  name="pcmsos_riscos_setores|funcoes|RISCOS[]" rows="5" cols="50"> </textarea></td>
    <td><textarea  name="pcmsos_riscos_setores|funcoes|EXAMES_COMPLEMENTARES[]" rows="5" cols="50"> </textarea></td>
  </tr>
  </table>
  </div>
</div>         			  
