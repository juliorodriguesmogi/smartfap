...
<body onload="inicializa_variaveis();">
    <script type="text/javascript">  
        ...
        function inicializa_variaveis(){
         ...
         function captura_linha_funcionario(ttr){
            ...
            function monta_consulta_funcionario(campo_origem,campo_pesquisa){
                ...
                div_pai.style.height='350px';
                div_pai.style.width='430px';
                ...
                colunas=Array('COD.FUNC.','MATRICULA_FUNCIONARIO','NOME_FUNCIONARIO');
            ...
            function consultar_funcionario(ntabela,campo_pesquisa,criterio){
                ...
                var parm=Array(empresa_ativa,(campo_pesquisa.value+"%"));
                ...
                cont=0;
                var valores=newregistros.getValores();
                valores=valores.toString().split(',');
                for(x=0;x<valores.length-1;x++){
                    var vreg=valores[x].split('|');
                    ...
                    tr.setAttribute('onclick', 'captura_linha_funcionario(this)');
        ...
        function captura_linha_medico(ttr){
            ...
            function monta_consulta_medico(campo_origem,campo_pesquisa){
                ...
                var tr=document.createElement('tr');
                thead.appendChild(tr);
                var colunas=Array('COD.MEDIC.','NOME MEDIC.','AREA DE ATUAÇÂO');
                for (xcab=0;xcab < 3;xcab++){
        ...
        function exibe_campos(){
            ...
            function carrega_campo(){
                 exame_atual=document.forms[2].elements['NATUREZA'].value;
                  buscar_registros(window,"exame","Carrega_Exames",null,null,true,null,newexames);
                 document.forms[2].elements['NATUREZA'].length=0;
                 document.forms[2].elements['NATUREZA'].add(new Option('Selecione um exame','0'));
                 for(i=1;i <= newexames.length();i++){
                        document.forms[2].elements['NATUREZA'].add(new Option(newexames.get_Nome(i-1),newexames.get_Nome(i-1)));
                 }       
            }
    ...
    function imprime_registro(){
	   ...
	   function carrega_unidades(){
		...
		divpai.removeChild(divremover);
            ...
            function pesquisa_funcionario(campo){
            ...
            function pesquisa_medico(campo){
                buscar_registro(window,campo.name,campo.value,'=','medicos','medicos','Busca_Medico',false,newmedico);
                document.forms[1].elements['NOME_PROFISSIONAL'].value=newmedico.get_Nome_Medico();
                
            }
        </script>
<center>
  <h1>Lan&ccedil;amento de Exames Laboratoriais de Funcionários</h1>
</center>
    ...
    <form id="frm_maquina" action="" method="POST">
        ...
        <div id="divCadastro" style="display: block">
          ...
          <tr>
            <td width="43">Número Movimento </td>
            <td width="60"><p>
                <input type="text" name="CODIGO_MOVIMENTACAO" class="input" maxlength="10" size="10" onblur="buscar_registro(window,this.name,this.value,'=','maquinas','maquinas','Busca_Maquina',true,newmaquina)" /><img src="../images/search.png" onclick="monta_consulta_funcionario(document.forms[1].elements['CODIGO_MAQUINA'],document.forms[1].elements['CODIGO_MAQUINA'])" width="10px" height="10px"/>
            </p></td>
            <td width="68"><div align="right">Codigo do Funcionario </div></td>
            <td width="69" ><input type="text" name="CODIGO_FUNCIONARIO"  class="input"  size="5" onblur="pesquisa_funcionario(this)" /><img src="../images/search.png" onclick="monta_consulta_funcionario(document.forms[1].elements['CODIGO_FUNCIONARIO'],document.forms[1].elements['CODIGO_FUNCIONARIO'])" width="10px" height="10px"/></td>
            <td width="91" >Matricula do Funcion&aacute;rio</td>
            <td width="132" ><input type="text" class="input" disabled="DISABLED" name="MATRICULA_FUNCIONARIO" maxlength="5" size="15"/></td>
            <td ><div align="right">Nome do Funcionario </div></td>
            <td width="300" ><input name="NOME_FUNCIONARIO" DISABLED="DISABLED" size='50'/>		   </td>
          ...
          <tr>
              ...
              <td>
                <select name="TIPO">
        		    <option value=""></option>
                            ...
                            <option value="PR">Periódico</option>
                            <option value="AL">Alteração Cargo/Função</option>
            ...
            <td>Codigo Medico </td>
            <td width="60"><input type="text" class="input"name="CODIGO_MEDICO" maxlength="5" size="10" onblur="pesquisa_medico(this)"/><img src="../images/search.png" onclick="monta_consulta_medico(document.forms[1].elements['CODIGO_MEDICO'],document.forms[1].elements['CODIGO_MEDICO'])" width="10px" height="10px"/></td>
          
            <td width="68"><div align="right">Nome do Medico </div></td>
            <td colspan="3"><input type="text" DISABLED="DISABLED"  name="NOME_PROFISSIONAL" maxlength="10" size="50"/></td>
          <td width="68"><div align="right">Area de Atuação </div></td>
            <td><input name="AREA_ATUACAO" DISABLED="DISABLED" size="30"/>		    </td> 

      </tr></table>
    </form>
            <form id="exame" action="" method="POST">
            <table bgcolor="whitesmoke" width="91%" class="tabela"  id="exames">
      
                <tr>
                  <td width="49">Data do Exame</td>
                  <td width="63"><input name="DATA" size="10" size="10" maxlength="10" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)"/></td>
                  <td width="48"><div align="right">Natureza do Exame</div></td>
                <td width="251"><select name="NATUREZA" onfocus="carrega_campo()" style="width:250px">
                        
            </select></td>
           <td width="77" >Indicação do Resultado</td>
           <td width="48" rowspan="2"><center>Normal
             <input type="radio" name="RESULTADO" id="radio" value ="NM"/></center></td>
           <td width="48" rowspan="2"><center>Alterado
             <input type="radio" name="RESULTADO" id="AL" value ="AL"/></center></td>
           <td width="43" rowspan="2"><center>
             Est&aacute;vel
             <input type="radio" name="CONDICAO" id="ES" value="ES"/></center></td>
           <td width="75" rowspan="2"><center>Agravamento
             <input type="radio" name="CONDICAO" id="AS" value="AG"/></center></td>
           <td width="74" rowspan="2"><center>Ocupacional
             <input type="radio" name="MOTIVO" id="OC" value="OC"/></center></td>
           <td width="97" rowspan="2"><center>
               Não-Ocupacional
               <input type="radio" name="MOTIVO" id="NO" value="NO"/></center></td>
          </tr>
        </table>
            <button type="button" onclick="insere(this)">+ Incluir Exame </button>		
		    <button type="button" onclick="remove(this)">- Remover Exame </button>
