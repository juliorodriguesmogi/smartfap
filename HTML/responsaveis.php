...
<script type="text/javascript">  
        ...
        function exibe_campos(){
                ...
                if (acao=='A'){
                        ...
                        //carrega_setores(document.forms[1].elements["SETOR"]);
                        //carrega_funcoes();
			...
			document.forms[1].elements["RG"].value = new String(newresponsavel.get_RG());
                        ...
                        //document.forms[1].elements["UNIDADE"].value = new String(newresponsavel.get_Unidade());
			//document.forms[1].elements["SETOR"].value = new String(newresponsavel.get_Setor());
                        document.forms[1].elements["TIPO_RESPONSAVEL"].value = new String(newresponsavel.get_Tipo_Responsavel());
          ...
          if (confirm("Imprimir registro corrente?")){
                ...
                document.forms[1].submit();
                 ...
                 for (y=1;y <=newfuncoes.length();y++){
                             opt=new Option(newfuncoes.get_Codigo_funcao([y-1])+"|"+newfuncoes.get_Descricao_funcao_empresa([y-1]).substr(0,100),newfuncoes.get_Codigo_funcao([y-1]));
            ...
            function carrega_setores(campo){
                 ...
                 chave=Array('UNIDADE');
                 Unidade=newresponsavel.get_Unidade();
                 valor=Array(Unidade);
...
<form id="frm_responsaveis"  name="frm_responsaveis" method="POST">
        <table width="30%" border="0" cellpadding="0" cellspacing="1" >
            <tr>
                ...
                Dados do Responsável</td>                

                
            </tr>
       </table>	
        <div id="divCadastro" style="display: block;background:whitesmoke;width:95%">
        <table bgcolor="whitesmoke" class="tabela" width="87%"  >
          <tr>
            <td width="68">Codigo </td>
            <td width="134"><input type="text" name="CODIGO_RESPONSAVEL" size="10" onblur="buscar_registro(window,this.name,this.value,'=','responsaveis','responsaveis','Busca_Responsavel',true,newresponsavel)"/>
                <img src="../images/search.png" onclick="monta_consulta_funcionario(document.forms[1].elements['CODIGO_RESPONSAVEL'],document.forms[1].elements['CODIGO_RESPONSAVEL'])" width="10px" height="10px"/></td>
            <td>Nome do Respons&aacute;vel </td>
            <td colspan="3"><input type="text" name="NOME_RESPONSAVEL" size="50" /></td>
            <td colspan="2">Data de Adimiss&atilde;o </td>
            <td width="86"><input type="text" name="DATA_ADMISSAO" size="10" onkeyup="return formata_data(this,'eu',event);" onkeypress="return valida_data(this,event)"  />
            </td>
            <td colspan="5">&nbsp;</td>
          </tr>
          <tr>
            <td width="68">N&uacute;mero do CPF</td>
            <td width="134"><input type="text" name="CPF" size="14" onblur="Formatar_CPF(this)" /></td>
            <td width="112">&nbsp;</td>
            <td>&nbsp;</td>
            <td>N&uacute;mero do RG</td>
            <td><input type="text" name="RG"  size="20"/></td>
            <td>&nbsp;</td>
            <td>N&uacute;mero do NIT</td>
            <td><input type="text" name="NUMERO_NIT"  size="20"/></td>
            <td colspan="9">N&iacute;vel do Profissional</td>
            <td colspan="9">
                <select name="TIPO_RESPONSAVEL">
                    <option value="">&nbsp</option>
                    <option value="2">Engenheiro de Seguran&ccedil;a</option>                    
                    <option value="1">T&eacute;cnico de Seguran&ccedil;a</option>
                </select>
            </td>
<!--Inicio funções expostas ruído
            ...
            <td colspan="2"><select name="FUNCAO" style="width:250px" onfocus="carrega_funcoes()">
            </select></td>
            <td width="21"><img id="funcimg" src="../images/gears.gif" width="15px" height="15px" style="visibility:hidden"/></td>
            <td width="95">Unidade de Trabalho </td>
            <td width="250"><select name="UNIDADE" id="UNIDADE" style="width:250px" onfocus="carrega_unidades(this)">
            </select></td>
            <td width="25"><img id="unidimg" src="../images/gears.gif" width="15px" height="15px" style="visibility:hidden"/></td>
            <td width="26">Setor de Trabalho</td>
            <td colspan="2" ><select name="SETOR" onfocus="carrega_setores(this)" style="width:250px">
            </select></td>
            <td width="53"><img id="setorimg" src="../images/gears.gif" width="15px" height="15px" style="visibility:hidden"/></td>
            <td colspan="4">&nbsp;</td>
            <td colspan="3">&nbsp;</td>
          </tr>
-->
