...
class Empresa{
    ...
    function insere_empresa(){
        if ($_SESSION['GRUPO']>2){
            header('location:../HTML/empresa.php?mensagem=Usuário não possui privilégios suficientes para essa operação');   
            break;
        }
        ...
        try{        
            ...
            header("location:../HTML/empresas.php?mensagem=Ocorreu um erro ao atualizar o registro. Verifique o log da aplicação");  
        }
    ...
    function apaga_empresa(){
        ...
        try{
            ...
            header("location:../HTML/empresas.php?mensagem=Ocorreu um erro ao excluir o registro. Verifique o log da aplicação");  
        }
