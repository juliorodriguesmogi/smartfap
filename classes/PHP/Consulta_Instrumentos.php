...
$conn->prepara_stmt('S', $tabela, array('CODIGO_INSTRUMENTO,DESCRICAO_INSTRUMENTO,CATEGORIA'),null,$campo,$condicao,$valor,null,array("DESCRICAO_INSTRUMENTO limit 100"));
$r=$conn->executa_acao();     
