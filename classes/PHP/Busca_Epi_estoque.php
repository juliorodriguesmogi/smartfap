...
$conn->prepara_stmt('S', array('epis e','epis_estoques f'),array('*'), null, array('e.CODIGO_EMPRESA','e.CODIGO_EPIS','e.CODIGO_EPIS','f.UNIDADE'), array('=','=','=','=','='),array('[f.CODIGO_EMPRESA]','[f.CODIGO_EPI]',$valor[0],$_SESSION['unidade']),null,array("e.CODIGO_EMPRESA"));
