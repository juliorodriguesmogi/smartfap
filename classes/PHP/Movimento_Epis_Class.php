...
//        $conn->prepara_stmt('I', 'movimento_epi_d', $this->nome_campos, $this->valor_campos, array('CODIGO_EMPRESA','SEQUENCIAL'), array('='),array($this->valor_campos[0],$this->valor_campos[1]));        
        ...
        try{
            ...
            $_SESSION['ULTIMO_USUARIO']=$row['ID_USUARIO'];
            ...
            header("location:../Reports/Relatorio_Entrega_EPIs.php?CODIGO_EMPRESA=$this->codigo_empresa&SEQUENCIAL=$sequencial&CODIGO_FUNCIONARIO=$codigo_funcionario");
            //header("location:../HTML/movimentacao_epis.php?mensagem=Registro atualizado com sucesso!&CODIGO_EMPRESA=$this->codigo_empresa&SEQUENCIAL=$sequencial&CODIGO_FUNCIONARIO=$codigo_funcionario");                    
            }
