...
$conn->prepara_stmt('S', $tabela, array('CODIGO_FUNCIONARIO,MATRICULA_FUNCIONARIO,NOME_FUNCIONARIO'),null,$campo,$condicao,$valor,null,array("NOME_FUNCIONARIO limit 100"));
$r=$conn->executa_acao();     
