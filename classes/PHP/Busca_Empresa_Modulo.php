...
$conn->prepara_stmt('S', $visao, array('CODIGO_MODULO'),null,$campo,$condicao,$valor,null);
$r=$conn->executa_acao();     
if ($r->fetchColumn(0)==0){
    ...
    $r=$conn->executa_acao();     
    $conn->prepara_stmt('S', 'modulos', array('DESCRICAO_MODULO'),null,array('CODIGO_MODULO'),array('='),array($r->fetchColumn(0)),null);
    $r=$conn->executa_acao();     
