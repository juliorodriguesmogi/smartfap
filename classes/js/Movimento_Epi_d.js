   function Movimento_Epi_d(){
                ...
                this.retorna_todas_linhas=function(){
                    ...
                    for (x=0;x<this.length();x++){
                        ...
                        xlinha[x]+='|'+this.get_Fabricante(x);
                ...
                this.setValores=function(response){
                    if (response!='NF'){
                        ...
                        D_Data_Entrega[x]=xvreg[9];
                        D_Proxima_Troca_Prevista[x]=xvreg[10];
                        D_Devolvido[x]=xvreg[11];
                        D_Data_Efetiva_Devolucao[x]=xvreg[12];
                        D_Fabricante[x]=xvreg[13]                        
