function MLaudos_avaliacoes_hidrocarbonetos_maquinas(){
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Sequencial[x]=vreg[4];
		 this.Unidade[x]=vreg[5];
		 this.Codigo_setor[x]=vreg[6];
...
newlaudosavaliacoes_hidrocarbonetos_maquinas=new MLaudos_avaliacoes_hidrocarbonetos_maquinas();
