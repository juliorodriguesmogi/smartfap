function MLaudos_avaliacoes_frio(){
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Temperatura_medida[x]=vreg[12];
		 this.Temperatura_permitida[x]=vreg[13];
...
newlaudosavaliacoes_frio=new MLaudos_avaliacoes_frio();
