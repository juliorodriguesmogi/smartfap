   function Recebimento_Epi_d(){
                ...
                this.get_Valor_Unitario= function(nlinha){
                    return D_Valor_Unitario[nlinha];
                }
                this.get_Valor_Total= function(nlinha){
                    return D_Valor_Total[nlinha];
                }
                ...
                this.apaga_linha=function(nlinha){
                     ...
                     D_Valor_Uniario.splice(nlinha,1);
                     D_Valor_Total.splice(nlinha,1);
                ...
                this.retorna_todas_linhas=function(){
                    ...
                    for (x=0;x<this.length();x++){
                        ...
                        xlinha[x]+='|'+this.get_Valor_Unitario(x);
                        xlinha[x]+='|'+this.get_Valor_Total(x);
                ...
                this.setValores=function(response){
                    if (response!='NF'){
                        ...
                        D_Valor_Unitario[x]=xvreg[7];
                        D_Valor_Total[x]=xvreg[8];
             ...
             newrecebimentoepi_d=new Recebimento_Epi_d();