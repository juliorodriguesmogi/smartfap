function MLaudos_avaliacoes_manejo_animais_maquinas(){
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Nom_maquina[x]=vreg[7];
		 this.Sequencial[x]=vreg[8];
		 this.Nivel_medido[x]=vreg[9];
		 this.Nivel_permitido[x]=vreg[10];
		 this.Observacoes[x]=vreg[11];
		 this.Id_usuario[x]=vreg[12];
		 this.Session_id[x]=vreg[13];
...
newlaudosavaliacoes_manejo_animais_maquinas=new MLaudos_avaliacoes_manejo_animais_maquinas();
