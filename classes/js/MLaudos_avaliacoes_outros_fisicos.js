function MLaudos_avaliacoes_outros_fisicos(){
...
this.get_Taxa_ruido_nr17=function(nlinha){
	 return this.Taxa_ruido_nr17[nlinha];
}
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Nivel_atenuacao_protetor[x]=vreg[12];
		 this.Nivel_ruido_atenuado[x]=vreg[13];
		 this.Medidas_protecao_coletiva[x]=vreg[14];
		 this.Medidas_protecao_coletiva_outros[x]=vreg[15];
		 this.Medidas_protecao_individual[x]=vreg[16];
		 this.Medidas_protecao_individual_outros[x]=vreg[17];
		 this.Fonte_geradora[x]=vreg[18];
...
newlaudosavaliacoes_outros_fisicos=new MLaudos_avaliacoes_outros_fisicos();
