function Mlaudos_avaliacoes_iluminamento(){
...
this.get_Lux_medido=function(nlinha){
	 return this.Lux_medido[nlinha];
}
this.get_Lux_nbr=function(nlinha){
	 return this.Lux_nbr[nlinha];
}
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Lux_medido[x]=vreg[12];
		 this.Lux_nbr[x]=vreg[13];
		 this.Medidas_protecao_coletiva[x]=vreg[14];
		 this.Medidas_protecao_individual[x]=vreg[15];
		 this.Medidas_protecao_coletiva_outros[x]=vreg[16];
...
newlaudoavaliluminamento =new Mlaudos_avaliacoes_iluminamento();
