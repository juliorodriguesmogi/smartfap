function MLaudos_avaliacoes_umidade_maquinas(){
this.inicializa=function(){
	 ...
	 this.Umidade_medida=Array();
	 this.Umidade_permitida=Array();
...
this.get_Umidade_medida=function(nlinha){
	 return this.Umidade_medida[nlinha];
}
this.get_Umidade_permitida=function(nlinha){
	 return this.Umidade_permitida[nlinha];
}
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Umidade_medida[x]=vreg[8];
		 this.Umidade_permitida[x]=vreg[9];
		 this.Id_usuario[x]=vreg[10];
		 this.Session_id[x]=vreg[11];
		 this.Ultima_atualizacao[x]=vreg[12];
		 this.Ultimo_usuario[x]=vreg[13];
		 this.Data_criacao[x]=vreg[14];
		 }
	}
}
};
newlaudosavaliacoes_umidade_maquinas=new MLaudos_avaliacoes_umidade_maquinas();
