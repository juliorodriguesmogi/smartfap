function MLaudos_avaliacoes_radiacao_nao_ionizante_maquiinas(){
this.inicializa=function(){
	 ...
	 this.Densidade_medida=Array();
	 this.Densidade_permitida=Array();
...
this.get_Densidade_medida=function(nlinha){
	 return this.Densidade_medida[nlinha];
}
this.get_Densidade_permitida=function(nlinha){
	 return this.Densidade_permitida[nlinha];
}
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Densidade_medida[x]=vreg[8];
		 this.Densidade_permitida[x]=vreg[9];
...
newlaudosavaliacoes_radiacao_nao_ionizante_maquiinas=new MLaudos_avaliacoes_radiacao_nao_ionizante_maquiinas();
