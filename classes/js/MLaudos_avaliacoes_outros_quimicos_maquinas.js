function MLaudos_avaliacoes_outros_quimicos_maquinas(){
...
this.setValores=function(response){
	 ...
	 if (response[0]!='NF'){
		 ...
		 this.Valor_medido[x]=vreg[9];
		 this.Valor_referencia[x]=vreg[10];
...
newlaudosavaliacoes_outros_quimicos_maquinas=new MLaudos_avaliacoes_outros_quimicos_maquinas();
