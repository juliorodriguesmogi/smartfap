...
class Funcionario{
    ...
    function insere_funcionario(){
        ...
        $conn->executa_acao();
        $conn->prepara_stmt('D', 'funcionarios_historico_lotacao_atribuicao', null,null,array($this->nome_campos[0],$this->nome_campos[1]),array('=','='),array($this->valor_campos[0],$this->valor_campos[1]),null,null);
        $conn->executa_acao();
        $conn->prepara_stmt('D', 'funcionarios_profissiografia', null,null,array($this->nome_campos[0],$this->nome_campos[1]),array('=','='),array($this->valor_campos[0],$this->valor_campos[1]),null,null);
        $conn->executa_acao();
