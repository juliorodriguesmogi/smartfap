...
<link href="estilosistema.css" type="text/css" rel="stylesheet" />
		...
		divpai.removeChild(divremover);
		 ...
		 buscar_registros(window,'laudos_avaliacoes_ruido',"Carrega_Avaliacoes_Ruido",campos_aval_ruido,valores_aval_ruido,false,Array('=','=','=','=','=','='),newlaudoavalruido);
                 indice=localizar_indice_componente(dv,'tabela_modelo_avaliacao_ruido_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0",'table');
		 ...
		 buscar_registros(window,'laudos_avaliacoes_iluminamento',"Carrega_Avaliacoes_iluminamento",campos_aval_iluminamento,valores_aval_iluminamento,false,Array('=','=','=','=','=','='),newlaudoavaliluminamento);
                 indice=localizar_indice_componente(dv,'tabela_modelo_avaliacao_iluminamento_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0",'table');
...
function exibir_historico_avaliacoes_manejo_animais(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_manejo_animais',"Carrega_Avaliacoes_manejo_animais",campos_aval_manejo_animais,valores_aval_manejo_animais,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_manejo_animais);
                 ...
                 divmaqmanejo_animais=tabelamanejo_animais.rows[8].cells[0].children[0];
...
function exibir_historico_avaliacoes_outros_biologicos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_outros_biologicos',"Carrega_Avaliacoes_outros_biologicos",campos_aval_outros_biologicos,valores_aval_outros_biologicos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_outros_biologicos);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_outros_biologicos.length();xs++){
                  ind=localizar_indice_componente(dv,'OUTROS_FISICOS_DESCRICAO','input');   
                  outdesc=dv.getElementsByTagName('input')[ind].value;
                  tabelaoutros_biologicos.rows[0].cells[0].children[0].innerHTML+=outdesc;
...
function exibir_historico_avaliacoes_hidrocarbonetos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_hidrocarbonetos',"Carrega_Avaliacoes_hidrocarbonetos",campos_aval_hidrocarbonetos,valores_aval_hidrocarbonetos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_hidrocarbonetos);
                 indice=localizar_indice_componente(dv,'tabela_modelo_avaliacao_hidrocarbonetos_aromaticos_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0",'table');
...
function exibir_historico_avaliacoes_poeiras_minerais(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_poeiras_minerais',"Carrega_Avaliacoes_poeiras_minerais",campos_aval_poeiras_minerais,valores_aval_poeiras_minerais,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_poeiras_minerais);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_poeiras_minerais.length();xs++){
                  ...
                  tabelapoeiras_minerais.rows[4].cells[1].children[1].value=newlaudosavaliacoes_poeiras_minerais.get_Codigo_setor(xs);
...
function exibir_historico_avaliacoes_outros_quimicos(dv){
		 ...
		 buscar_registros(window,'laudos_avaliacoes_outros_quimicos',"Carrega_Avaliacoes_outros_quimicos",campos_aval_outros_quimicos,valores_aval_outros_quimicos,false,Array('=','=','=','=','=','='),newlaudosavaliacoes_outros_quimicos);
                 ...
                 for (xs=0;xs<newlaudosavaliacoes_outros_quimicos.length();xs++){
                  ind=localizar_indice_componente(dv,'OUTROS_FISICOS_DESCRICAO','input');   
                  outdesc=dv.getElementsByTagName('input')[ind].value;
                  tabelaoutros_quimicos.rows[0].cells[0].children[0].innerHTML+=outdesc;
            ...
            function carregar_atividade_epis_fornecidos_historico(codativ){
                        ...
                        if (newlaudoativepis.length()>0){
                            ...
                            while (cont<newlaudoativepis.length()){
                              ...
                              linha_atual_epi.cells[0].children[0].children[2].children[0].children[0].value=newlaudoativepis.get_Codigo_EPI(cont);
                              linha_atual_epi.cells[0].children[0].children[2].children[1].children[0].value=newlaudoativepis.get_Codigo_CA(cont);
                              cont++;
					...
					td.appendChild(divatual);
                                        ...
                                        if (divatual.getElementsByTagName('input')[1].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_ruido_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[3].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_ruido_dosimetria_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[5].checked) {
                                             ...
                                             for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_frio_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[7].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_calor_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[9].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_umidade_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[11].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_radiacao_nao_ionizante_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[13].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_radiacao_ionizante_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[15].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_outros_fisicos_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                                tabela.rows[0].cells[0].firstChild.textContent=tabela.rows[0].cells[0].firstChild.firstChild.textContent+'  '+'OUTROS FÍSICOS '+newlaudosavalsum.get_Outros_Fisicos_Descricao(0)	;
                                                tabela.rows[1].cells[0].firstChild.textContent='Avaliação '+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase();
                                                tabela.setAttribute('style','display:block;overflow:auto');
                                        ...
                                        if (divatual.getElementsByTagName('input')[18].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_sangue_humano_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[20].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_sangue_animal_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[22].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_manejo_animais_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[24].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_outros_biologicos_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[27].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_produtos_limpeza_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[29].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_tintas_solventes_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[31].checked) {
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_hidrocarbonetos_aromaticos_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[33].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_fumos_metalicos_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[35].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_poeiras_incomodas_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[37].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_poeiras_minerais_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[39].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_outros_quimicos_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
                                        ...
                                        if (divatual.getElementsByTagName('input')[42].checked){
                                            ...
                                            for (l=0;l<newlaudostipoaval.length();l++){
                                                ...
                                                tabela.setAttribute('id','tabela_modelo_avaliacao_iluminamento_'+newlaudostipoaval.get_Tipo_avaliacao(l).toString().toLowerCase()+"_0");
...
<td colspan="4"><div align="center">Texto Explicativo </div></td>
        ...
        <tr><td colspan="5">
		  ...
		  <td><select name="laudos_avaliacoes_ruido|FONTE_GERADORA[]"></select></td>
		  </tr>	
          <tr>
            <td >Enquadramento</td>
    ...
    <tr>
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_outros_fisicos" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
...
<table width="100%" border="0" class="tabela" id="tabela_modelo_avaliacao_manejo_animais" style="display:none">
          ...
          <tr >
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_manejo_animais" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
...
<table width="100%" border="0" class="tabela" id="tabela_modelo_avaliacao_outros_biologicos" style="display:none">
          <tr>
            <td colspan="4"><div align="center">Avalia&ccedil;&atilde;o de Agentes</div></td>
          </tr>
          <tr>
    ...
    <tr>
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_outros_biologicos" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
    ...
    <tr>
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_produtos_limpeza" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_tintas_solventes" style="display:none">
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_tintas_solventes" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
			  ...
			  <input type="hidden" id="CD_SETOR" name="laudos_avaliacoes_tintas_solventes_maquinas|CODIGO_SETOR[]" size="0"/></td>
                                      ...
                                      <td width="35%"  ><input type="text" name="laudos_avaliacoes_tintas_solventes_maquinas|NIVEL_MEDIDO[]" value="0" onkeypress="return valida_decimal(this,event)" onblur="formata_decimal_casas(this,'eu',1)"/></td>
                                      <td width="28%" ><input type="text" name="laudos_avaliacoes_tintas_solventes_maquinas|NIVEL_PERMITIDO[]" value="0" onkeypress="return valida_decimal(this,event)" onblur="formata_decimal_casas(this,'eu',1)"/></td>
                                    </tr>         
                                </table>
                                <button type="button" onclick="insere_maquina(this)">+Inserir Registro</button>
                                <button type="button" onclick="remove_maquina(this)">-Remover Registro</button>
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_hidrocarbonetos_aromaticos" style="display:none">
          ...
          <tr>
            <td >Periodicidade de exposi&ccedil;&atilde;o </td>	
              ...
              <td>
			  <input type="hidden" id="CD_UNIDADE" name="laudos_avaliacoes_hidrocarbonetos|UNIDADE[]"/>
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_hidrocarbonetos" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
    ...
    <tr>
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_fumos_metalicos" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
    ...
    <tr>
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_poeiras_incomodas" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_poeiras_minerais" style="display:none">
        ...
        <tr>
	  <td >Fonte geradora</td>
	  <td><select name="laudos_avaliacoes_poeiras_minerais|FONTE_GERADORA[]"></select></td>
	  </tr>	
...
<table width="99%" border="0" class="tabela" id="tabela_modelo_avaliacao_iluminamento" style="display:none">
    ...
    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
...
<table width="100%" border="0" class="tabela" id="tabela_modelo_avaliacao_outros_quimicos" style="display:none">
          <tr>
            <td colspan="4"><div align="center">Avalia&ccedil;&atilde;o de Agentes</div></td>
          </tr>
          <tr>
    ...
    <tr>
          ...
          <tr>
			  ...
			  <div align="center" >Local/M&aacute;quinas e Equipamentos </div></td>
                    ...
                    <tr  ><td colspan="3" id="td_maq_equip" ><div></div><div id="div_maq_equip_outros_quimicos" style="width:100%;background: appworkspace;overflow:visible ">
                                <div id="m_equip">
                                <table id="tbl_maq_equip" width="99%" border="0" >
                                    <tr>                          
		...
		<tr>
		  ...
		  <td colspan="3"><select name="laudos_avaliacoes|CODIGO_SETOR[]" style="width:250px" onfocus="carrega_setores(this)">
			  ...
			  <input type="hidden" name="laudos_avaliacoes|OUTROS_QUIMICOS[]" value="0"   onclick="registrar_fator(this)"/>
                                Outros
                            <input name="laudos_avaliacoes|OUTROS_QUIMICOS_DESCRICAO[]" id="OUTROS_QUIMICOS_DESCRICAO" type="text" size="15" maxlength="30" />                        </td>
                  </tr>
                  <tr>
