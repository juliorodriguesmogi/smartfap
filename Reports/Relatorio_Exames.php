...
<div align="right"><button type="button" onClick="window.print()"><img src='../images/printer_2.png'/></button></div>
   <table id="cabecalho_pagina" width="100%" style="border-bottom:solid 1px"  >
    ...
    <th colspan="2"><center>
      <h2>Relatório de Tipos de Exames cadastrados </h2>
    </center></th>
	<th></th>		
  </tr>
  <tr>
...
<table width="100%" >    
  <tr id="cabecalho_campos" style="border-bottom:solid 1px" >
    ...
    <td  width="6%" rowspan="2" valign="top">Nome </td>
   <td  width="4%" rowspan="2" valign="top">Descrição </td>
...
$conn->prepara_stmt('S', 'exame',array('*'), null,null , null,null,array("CODIGO_EXAME"));
...
?>
    ...
    <td width="6%"><?php echo $row['CODIGO_EXAME']?></td>
    <td width="13%"><?php echo mb_strtoupper($row['NOME'])?></td>
