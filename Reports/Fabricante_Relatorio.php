...
<table width="100%" >    
  <tr id="cabecalho_campos" style="border-bottom:solid 1px" >
    ...
    <td  width="8%" rowspan="2">Descrição  </td>
    <td  width="1%" rowspan="2">CNPJ</td>
...
?>
    ...
    <td width="8%" align="center"><?php echo $row['DESCRICAO']?></div></td>
	<td width="8%"><?php echo $row['CNPJ']?></td>
