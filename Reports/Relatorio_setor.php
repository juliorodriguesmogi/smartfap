...
$conn->prepara_stmt('S', 'setores',array('*'), null, array('CODIGO_EMPRESA','UNIDADE','CODIGO_SETOR'), array('=','='),array($codigo_empresa,$unidade,$codigo_setor),null,array("UNIDADE","CODIGO_SETOR"));
$r=$conn->executa_acao();        
...
?>
     ...
     <tr>
       ...
       <td width="5%"><?php echo $row['CODIGO_SETOR']?></td>
     </tr>
     <tr>
       <td  width="7%">Unidade</td>
       <td width="7%"><?php echo mb_strtoupper($row['UNIDADE'])?></td>
     </tr>
     <tr>
       <td  width="24%">Nome
       <td width="24%" ><?php echo $row['NOME_SETOR']?></td>
     </tr>
     <tr>
       <td  width="24%">Descrição
       <td width="24%" ><?php echo $row['DESCRICAO']?></td>
     </tr>
