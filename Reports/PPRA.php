...
<div align="right"><button type="button" onClick="window.print()"><img src='../images/printer_2.png'/></button></div>
   <table id="cabecalho_pagina" width="100%" style="border-bottom:solid 1px"  >
    ...
    <th colspan="2"><center>
        <table  ><tr><td>PROGRAMA DE PREVEN��O DE RISCOS AMBIENTAIS </td><td></td></tr></table>
    </center></th>
	<th></th>		
  </tr>
  <tr>
...
<table width="100%" >    
  <tr id="cabecalho_campos" style="border-bottom:solid 1px" >
    ...
    <td  width="9%" rowspan="2">Tipo de Uso  </td>
    <td  width="8%" rowspan="2">Taxa de Ruído</td>
    <td  width="9%" rowspan="2">Fabricante </td>
    <td  width="15%" colspan="2" rowspan="2">Vida Útil </td>
...
?>
    ...
    <td width="9%" align="center"><?php echo $row['TIPO_DE_USO']?></div></td>
	...
	<td width="0%"><?php echo $row['ID_USUARIO']?></td>
