...
?>
     ...
     <tr>
       <td  width="5%">Codigo da Função</td>
     ...
     <tr>
       <td  width="24%">CBO da ocupação</td>
     ...
     <tr>
       <td  width="24%">Descrição resumida da familia</td>
       <td width="24%" ><?php echo $row['DESCRICAO_RESUMIDA_FAMILIA']?></td>
     </tr>
     <tr>
       <td  width="24%">Descrição resuimida da ocupação</td>
